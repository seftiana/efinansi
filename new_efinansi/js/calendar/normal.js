...
// ---- Common Options ----
var gMonths=["Jan","Feb","Mar","Apr","Mei","Jun","Jul","Ags","Sep","Okt","Nov","Des"];
var gWeekDay=["Mg","Sn","Sl","Rb","Km","Jm","Sb"];	// weekday caption from Sunday to Saturday

//var gBegin=[gToday[0]-5,1,1];	// calendar date range begin from [Year,Month,Date]. Using gToday here will make it start from today.
var gBegin=[1900,1,1];	// calendar date range begin from [Year,Month,Date]. Using gToday here will make it start from today.
var gEnd=[gToday[0]+5,12,31];	// calendar date range end at [Year,Month,Date]
...
var gcCalBG="#f8f9f5";	// the background color of the outer calendar panel.
...
var gsBottom="<A href='javascript:void(0)' class='BottomAnchor' onclick='if(this.blur)this.blur();if(!fSetDate(gToday[0],gToday[1],gToday[2]))alert(\"You cannot select today!\");return false;' onmouseover='return true;' >Hari ini : "+gToday[2]+" "+gMonths[gToday[1]-1]+" "+gToday[0]+"</A>";	// the content of the bottom section.
...
var gcSunBG="#ccccff";	// Sunday background color
...
var gcToggle="999999";	// the highlight color for the focused cell
...
var gsTodayTip="Hari ini";	// tooltip for today
