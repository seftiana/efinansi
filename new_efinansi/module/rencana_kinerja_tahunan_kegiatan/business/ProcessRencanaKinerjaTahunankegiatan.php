...
class ProcessRencanaKinerjaTahunankegiatan {
    ...
    function __construct() {
        ...
        $this->urlAdd = Dispatcher::Instance()->GetUrl(
                        'rencana_kinerja_tahunan_kegiatan', 'InputKinerjaTahunan', 'view', 'html'
                ) . '&' . $queryString;
        $this->urlEdit = Dispatcher::Instance()->GetUrl(
                        'rencana_kinerja_tahunan_kegiatan', 'EditKinerjaTahunan', 'view', 'html'
                ) . '&' . $queryString;
        $this->urlList = Dispatcher::Instance()->GetUrl(
                        'rencana_kinerja_tahunan_kegiatan', 'RencanaKinerjaTahunan', 'view', 'html'
    ...
    private function setData() {
	    ...
	    $requestData['jenis_rpc'] = $this->mObj->_POST['jenis_rpc']; #add ccp 28-11-2019
    ...
    public function Save() {
        ...
        if ($check['result'] === false) {
            ...
            $taPilih = $this->mObj->GetTahunAnggaranById($this->mObj->_POST['tahun_anggaran']);            
            $taBuka = $taPilih['tabuka'];
            $taTutup = $taPilih['tatutup'];
