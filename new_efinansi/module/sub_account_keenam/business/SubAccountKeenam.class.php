 ...
 */
  ...
  */
class SubAccountKeenam extends Database
{
   protected $mSqlFile;
   public $_POST;
   public $_GET;
   ...
   {
      $this->mSqlFile   = 'module/sub_account_keenam/business/sub_account_keenam.sql.php';
   ...
   {
      return $this->Execute($this->mSqlQueries['do_add_sub_account_keenam'], array(
         $subAccKode,
         $subAccNama
      ));
   }
   ...
   {
      return $this->Execute($this->mSqlQueries['do_update_sub_account_keenam'],
   ...
   {
      return $this->Execute($this->mSqlQueries['do_delete_sub_account_keenam'], array($subAccKode));
   }
