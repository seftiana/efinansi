...
'module/history_transaksi_pengeluaran/business/AppPopupMakPenerimaan.class.php';
...
class ViewPopupMakPenerimaan extends HtmlResponse {
	...
	function ParseTemplate($data = NULL) {
		...
		$this->mrTemplate->AddVar('content', 'URL_SEARCH', Dispatcher::Instance()->GetUrl('history_transaksi_pengeluaran', 'PopupMakPenerimaan', 'view', 'html'));
		if($this->Pesan) {
