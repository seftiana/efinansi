 ...
 */
  ...
  */
class SubAccountPertama extends Database
{
   protected $mSqlFile;
   public $_POST;
   public $_GET;
   ...
   {
      $this->mSqlFile   = 'module/sub_account_pertama/business/sub_account_pertama.sql.php';
   ...
   {
      return $this->Execute($this->mSqlQueries['do_add_sub_account_pertama'], array(
         $subAccKode,
         $subAccNama
      ));
   }
   ...
   {
      return $this->Execute($this->mSqlQueries['do_update_sub_account_pertama'],
   ...
   {
      return $this->Execute($this->mSqlQueries['do_delete_sub_account_pertama'], array($subAccKode));
   }
