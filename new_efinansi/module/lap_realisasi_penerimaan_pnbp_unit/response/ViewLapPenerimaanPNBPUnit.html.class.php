 ...
 * Class ViewLapPenerimaanPNBPUnit
 * @since 27 Maret 2012
...
class ViewLapPenerimaanPNBPUnit extends HtmlResponse
{
	...
	public function TemplateModule()
    {
		$this->SetTemplateBasedir(GTFWConfiguration::GetValue('application','docroot').
			'module/lap_realisasi_penerimaan_pnbp_unit/template');
	...
	public function ProcessRequest()
    {
        ...
        $data_pnbp = $Obj->GetDataRealisasiPNBP(
                                    $this->Data['tahun_anggaran'],
                                    $this->Data['unitkerja'],
                                    $startRec,
                                    $itemViewed);
        $total_data_pnbp_perbulan = $Obj->GetTotalDataRealisasiPNBPPerBulan(
                                                    $this->Data['tahun_anggaran'],
                                                    $this->Data['unitkerja']);
	...
	public function ParseTemplate($data = NULL)
    {
		...
		$this->mrTemplate->AddVar('content', 'URL_SEARCH',
                    Dispatcher::Instance()->GetUrl(
                                        'lap_realisasi_penerimaan_pnbp_unit',
                                        'lapPenerimaanPNBPUnit',
                                        'view',
                                        'html'));
