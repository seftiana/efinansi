...
class ViewReferensiTransaksi extends HtmlResponse
{
   function TemplateModule(){
      $this->SetTemplateBasedir(GTFWConfiguration::GetValue('application','docroot').
      'module/finansi_jurnal_pengeluaran/template/');
      $this->SetTemplateFile('view_referensi_transaksi.html');
   }
   ...
   function ProcessRequest(){
      ...
      $getCoaPengeluaran         =  $mObj->GetCoaTransaksiPengeluran();
      //print_r($getCoaPengeluaran);
      $return['coa']['data']     = json_encode($getCoaPengeluaran['data_grid']);
   ...
   function ParseTemplate($data = null){
      ...
      $object['data']      = json_encode($transaksi);
      $this->mrTemplate->AddVars('content', $object, 'TRANSAKSI_');
      //print_r($dataCoa);
      if(!empty($dataCoa)) {
        $this->mrTemplate->AddVars('content', $dataCoa, 'COA_');
      } else {
        $this->mrTemplate->AddVars('content', NULL, 'COA_');
      }
   }
}
?>