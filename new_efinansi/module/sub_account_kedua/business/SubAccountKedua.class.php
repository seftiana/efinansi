 ...
 */
 ...
 /**
  * Class SubAccountKedua
  * @todo Untuk menghandle manipulasi data dalam tabel finansi_keu_ref_subacc_2
  */
class SubAccountKedua extends Database
{
   protected $mSqlFile;
   public $_POST;
   public $_GET;
   ...
   {
      $this->mSqlFile   = 'module/sub_account_kedua/business/sub_account_kedua.sql.php';
   ...
   {
      return $this->Execute($this->mSqlQueries['do_add_sub_account_kedua'], array(
         $subAccKode,
         $subAccNama
      ));
   }
   ...
   {
      return $this->Execute($this->mSqlQueries['do_update_sub_account_kedua'],
   ...
   {
      return $this->Execute($this->mSqlQueries['do_delete_sub_account_kedua'], array($subAccKode));
   }
