...
class ProcessTransaksi {
	...
	/**
	 * digunakan untuk proses Generate Number
	 */
	var $tipeTransaksiSpj = 100;
         ...
         if(empty($this->_POST['no_invoice_list'])) {
            ...
            if($id_transaksi != "") {
               ...
               if($this->_POST['mak'] != "") {
                  ...
                  if($this->_POST['tipe_transaksi'] == 6)
                     $pencairan = $this->Obj->DoAddTransaksiDetilSPJ($id_transaksi, $this->_POST['mak']);
                  elseif($this->_POST['tipe_transaksi'] == 5 AND $this->_POST['unitkerja'] != 1)
               ...
               if($this->_POST['peng_real_id'] != '')
                  $update_status_transaksi = 
						$this->Obj->DoUpdateStatusTransaksiDiPengajuanRealisasi($this->_POST['peng_real_id']);
