...
require_once GTFWConfiguration::GetValue( 'application', 'docroot') . 
	'module/history_transaksi/business/transaksi_pengeluaran/AppTransaksi.class.php';
...
class ViewHTFormPengeluaran extends HtmlResponse 
{
	...
	public function ParseTemplate($data = NULL) 
	{
		...
		$this->mrTemplate->AddVar('content','NAME_TIPE_TRANSAKSI',$data['tipe_transaksi'][0]['name']);
      	$url_view = Dispatcher::Instance()->GetUrl('history_transaksi', 'HTFormPengeluaran', 'view', 'html');
