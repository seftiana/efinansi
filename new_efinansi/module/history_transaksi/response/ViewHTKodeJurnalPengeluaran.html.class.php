...
require_once GTFWConfiguration::GetValue( 'application', 'docroot') . 
		'module/history_transaksi/business/HTKodeJurnalPengeluaran.class.php';

class ViewHTKodeJurnalPengeluaran extends HtmlResponse 
{
	protected $Pesan;
	...
	public function TemplateModule() 
	{
		...
		$this->SetTemplateFile('view_ht_kode_jurnal_pengeluaran.html');
	}
	
	public function ProcessRequest() 
	{
		$Obj = new HTKodeJurnalPengeluaran();
	...
	public function ParseTemplate($data = NULL) 
	{
		...
		if (empty($data['dataDetilTransaksi'])) {
			...
			$this->mrTemplate->AddVar('data', 'DATA_EMPTY', 'NO');
         	...
         	$label =GTFWConfiguration::GetValue('language','transaksi_kode_jurnal_pengeluaran');
         	$urlDelete = 'history_transaksi|deleteTransaksi|do|html';
         	$urlReturn = 'history_transaksi|HTKodeJurnalPengeluaran|view|html';
            	...
            	if($dataDetilTransaksi[$i]['tipe_id'] == 1) {
               		$dataDetilTransaksi[$i]['url_cetak_bukti'] = 
		   								Dispatcher::Instance()->GetUrl(
										   					...
										   					'&dataId=' . $idEnc . 
										   					'&tipe=bkm'.
														'&request=transaksi_kode_jurnal_pengeluaran';
