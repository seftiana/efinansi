...
require_once GTFWConfiguration::GetValue( 'application', 'docroot') . 
	'module/history_transaksi/business/transaksi_realisasi/AppTransaksi.class.php';
...
class ViewHTFormRealisasiPencairan extends HtmlResponse {
	...
	function ParseTemplate($data = NULL) {
      ...
      $this->mrTemplate->AddVar('content', 'URL_POPUP_SISA_ANGGARAN', 
  		Dispatcher::Instance()->GetUrl('history_transaksi', 'popupSisaAnggaran', 'view', 'html'));
      $datadb = $data['datadb'];
		/**
...
//print_r($this->Data);
      ...
      if(isset($_GET['dataId']) AND $_GET['dataId']->Integer()->Raw() > 0) {
         ...
         $this->mrTemplate->AddVar('content', 'URL_ACTION', 
		 					Dispatcher::Instance()->GetUrl('history_transaksi', 
