...
require_once GTFWConfiguration::GetValue( 'application', 'docroot') . 
	'module/history_transaksi/business/HTRealisasiPenerimaan.class.php';
...
class ViewHTRealisasiPenerimaan extends HtmlResponse 
{
	...
	public function ParseTemplate($data = NULL) 
	{
		...
		if (empty($data['dataHTRealisasiPenerimaan'])) {
         ...
         $urlDelete = 'history_transaksi|deleteHTRealisasiPenerimaan|do|html';
         $urlReturn = 'history_transaksi|HTRealisasiPenerimaan|view|html';
...
//mulai bikin tombol delete
			#$label = "Transaksi";
			#$urlDelete = Dispatcher::Instance()->GetUrl('history_transaksi', 'deleteTransaksi', 'do', 'html');
			#$urlReturn = Dispatcher::Instance()->GetUrl('history_transaksi', 'HTRealisasiPenerimaan', 'view', 'html');
            ...
            if($dataHTRealisasiPenerimaan[$i]['tipe_id'] == 1) {
               ...
               #$url_cetak_bukti = Dispatcher::Instance()->GetUrl('history_transaksi', 'CetakBuktiTransaksi', 'view', 'html') . '&dataId=' . $idEnc . '&tipe=bkm';
               ...
               #$url_cetak_bukti = Dispatcher::Instance()->GetUrl('history_transaksi', 'CetakBuktiTransaksi', 'view', 'html') . '&dataId=' . $idEnc . '&tipe=bkk';
