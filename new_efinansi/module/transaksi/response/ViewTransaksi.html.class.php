...
class ViewTransaksi extends HtmlResponse 
{
	...
	public function ProcessRequest() 
	{
      ...
      /** auto number diganti dengan melalui proses di modul GenerateNumber
      if(!empty($this->_POST['check']) AND $this->_POST['check'] == 'yes') {
         ...
         $count_bukti_trans = $Obj->CountBuktiTrans(
	...
	*/
      ...
      /** deprecated
		Messenger::Instance()->SendToComponent(
										'combobox', 'Combobox', 'view', 'html', 'jenis_transaksi', 
       ...
       */
       ...
       /**
        * ganti tanpa jsCheck()
        * diganti dengan menggunakan teknik generateNumber
        */
	   Messenger::Instance()->SendToComponent(
	   											'combobox', 
											    'Combobox', 
	...
	{ 
      	$url_view = Dispatcher::Instance()->GetUrl('transaksi', 'transaksi', 'view', 'html');
