...
require_once GTFWConfiguration::GetValue( 'application', 'docroot') . 'module/jurnal_pengeluaran/business/AppPopupCoa.class.php';
...
class PopupCoa extends HtmlResponse {
   ...
   function ParseTemplate($data = NULL) {      
      ...
      $this->mrTemplate->AddVar('content', 'URL_SEARCH', Dispatcher::Instance()->GetUrl('jurnal_pengeluaran', 'coa', 'popup', 'html').'&data[name]='.$this->data['nama']);      
