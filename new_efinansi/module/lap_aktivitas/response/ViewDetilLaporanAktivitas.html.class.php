...
require_once GTFWConfiguration::GetValue('application', 'docroot') . 'module/lap_aktivitas/business/AppDetilLaporanAktivitas.class.php';

class ViewDetilLaporanAktivitas extends HtmlResponse {

    var $Pesan;

    function TemplateModule() {
        $this->SetTemplateBasedir(GTFWConfiguration::GetValue('application', 'docroot') . 'module/lap_aktivitas/template');
        $this->SetTemplateFile('view_detil_lap_aktivitas.html');
    }
    ...
    function ProcessRequest() {
        ...
        $data_list = $Obj->GetDataDetilKlpLaporan($tanggal_awal, $tanggal, $id_kel_lap, $key, $startRec, $itemViewed);
//    print_r($data_list);
