...
class RekapUnitKerja extends Database {
   ...
   public function GetDataResume($param = array())
   {
      ...
      if(!empty($return)) {
         foreach($return as $data) {                   
            $formatData[$data['taId']][$data['unitId']][$data['programId']]['nominal_usulan']         = $data['nominalUsulan'];
            $formatData[$data['taId']][$data['unitId']][$data['programId']]['nominal_setuju']         = $data['nominalSetuju'];
            $formatData[$data['taId']][$data['unitId']][$data['programId']]['nominal_revisi']         = $data['nominalRevisi'];
            $formatData[$data['taId']][$data['unitId']][$data['programId']]['nominal_setelah_revisi']  = $data['nominalSetelahRevisi'];
            $formatData[$data['taId']][$data['unitId']][$data['programId']]['nominal_pencairan']      = $data['nominalPencairan'];
            $formatData[$data['taId']][$data['unitId']][$data['programId']]['nominal_realisasi']      = $data['nominalRealisasi'];
            $formatData[$data['taId']][$data['unitId']][$data['programId']]['nominal_lppa']           = $data['nominalLppa'];
            $formatData[$data['taId']][$data['unitId']][$data['programId']]['nominal_lppa_sisa']      = $data['nominalLppaSisa'];
            $formatData[$data['taId']][$data['unitId']][$data['programId']]['nominal_sisa_dana']      = $data['sisaDana'];
         }
      }
   ...
   public function GetDataResumeUnit($param = array())
   {
      $return     = $this->Open($this->mSqlQueries['get_data_resume_unit'], array(
  ...
  function GetCountUnitKerja ($nama) {
   ...
   function GetProgramRef($taId){
      return $this->Open($this->mSqlQueries['get_program_ref'],array($taId));
   }
