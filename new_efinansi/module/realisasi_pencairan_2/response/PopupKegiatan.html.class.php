<?php
require_once GTFWConfiguration::GetValue( 'application', 'docroot') . 'module/realisasi_pencairan_2/business/AppPopupKegiatan.class.php';
...
class PopupKegiatan extends HtmlResponse {
	...
	function ParseTemplate($data = NULL) {
		...
		$this->mrTemplate->AddVar('content', 'URL_SEARCH', Dispatcher::Instance()->GetUrl('realisasi_pencairan_2', 'kegiatan', 'popup', 'html') . '&programId=' . $this->encProgramId . '&grp=' . $_GET['grp']);
		if($this->Pesan) {
