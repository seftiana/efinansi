...
class RencanaPengeluaran extends Database
{
   ...
   function __construct($connectionNumber=0)
   {
      ...
      $this->mSqlFile      = 'module/rencana_pengeluaran/business/rencana_pengeluaran.sql.php';
   ...
   function GetData ($offset, $limit, $param = array())
   {
      ...
      $kegDetId = $this->Open($this->mSqlQueries['get_data_kegdet_id'],array(
         $param['ta_id'],
         $param['unit_id'],
         $param['unit_id'],
         $param['unit_id'],
      ...
      if(!empty($kegDetId)){
         foreach($kegDetId as $value){
            $param['keg_det_id'][] = $value['id'];
         }         
      }
