...
class Upload extends Database
{
   ...
   {
      $this->mSqlFile      = 'module/'.Dispatcher::Instance()->mModule.'/business/upload.sql.php';
      $this->_POST         = is_object($_POST) ? $_POST->AsArray() : $_POST;
      $this->_GET          = is_object($_GET) ? $_GET->AsArray() : $_GET;
      parent::__construct($connectionNumber);
   }

   public function UpdateFileRAB($fileName, $id)
   {
      $result =  $this->Execute($this->mSqlQueries['update_upload_file'],array(
         $fileName,
         $id
      ));
      return $result;
