...
/**
* ================= doc ====================
* FILENAME     : ViewExcelLapRencanaPenerimaanAlokasiUnit.xlsx.class.php
* @package     : ViewExcelLapRencanaPenerimaanAlokasiUnit
* scope        : PUBLIC
* @Author      : Eko Susilo
* @Created     : 2014-07-10
* @Modified    : 2014-07-10
...
'module/lap_rencana_penerimaan_alokasi_unit/business/AppLapRencanaPenerimaanAlokasiUnit.class.php';
require_once GTFWConfiguration::GetValue( 'application', 'docroot') .
'module/user_unit_kerja/business/UserUnitKerja.class.php';

class ViewExcelLapRencanaPenerimaanAlokasiUnit extends XlsxResponse
{
   # Internal Variables
   public $Excel;
   ...
   function ProcessRequest()
   {
      ...
      $this->SetFileName('laporan_rencana_penerimaan_alokasi_unit_'.date('Ymd', time()).'.xls');
