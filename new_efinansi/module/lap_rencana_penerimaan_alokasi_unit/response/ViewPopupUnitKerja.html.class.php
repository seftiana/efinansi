...
require_once GTFWConfiguration::GetValue( 'application', 'docroot') . 
	'module/lap_rencana_penerimaan_alokasi_unit/business/AppPopupUnitKerja.class.php';
require_once GTFWConfiguration::GetValue( 'application', 'docroot') . 
...
class ViewPopupUnitkerja extends HtmlResponse 
{
	...
	function TemplateModule() {
		$this->SetTemplateBasedir(GTFWConfiguration::GetValue('application','docroot').
				'module/lap_rencana_penerimaan_alokasi_unit/template');
	...
	//view
		$totalData = $unitkerjaObj->GetCountDataUnitkerja(
													$kode, 
													$unitkerja, 
													$tipeunit,
	...
	function ParseTemplate($data = NULL) {
		...
		$this->mrTemplate->AddVar('content', 'URL_SEARCH', 
							Dispatcher::Instance()->GetUrl(
											'lap_rencana_penerimaan_alokasi_unit', 
											'popupUnitKerja', 
											'view', 
											'html') . 
