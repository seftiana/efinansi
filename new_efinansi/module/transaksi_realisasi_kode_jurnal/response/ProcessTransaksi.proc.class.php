   ...
   var $cssAlert = "notebox-alert";
	...
	function __construct() {
		...
		$this->pageView = Dispatcher::Instance()->GetUrl(
									'transaksi_realisasi_kode_jurnal', 
									'Transaksi', 
									'view', 
									'html');
		...
		$this->pageDetil = Dispatcher::Instance()->GetUrl(
									'history_transaksi', 
									'HTRealisasiPencairanKodeJurnal', 
									'view', 
									'html');
	...
	function Add() { 
		...
		if($cek === true) {
         ...
         //echo "666";
         Messenger::Instance()->Send('transaksi_realisasi_kode_jurnal', 'Transaksi', 'view', 'html', array($this->_POST,'Transaksi Dengan Nomor <b>'.($this->_POST['no_kkb']).'</b> Sudah Dibuat', $this->cssFail),Messenger::NextRequest);
      } elseif($cek === "COA") {
         //echo "666";
         Messenger::Instance()->Send('transaksi_realisasi_kode_jurnal', 'Transaksi', 'view', 'html', array($this->_POST,'Kode Jurnal belum dipilih!', $this->cssFail),Messenger::NextRequest);
      } else {
         //gagal masukin data
         Messenger::Instance()->Send('transaksi_realisasi_kode_jurnal', 'Transaksi', 'view', 'html', array($this->_POST,'Gagal Menambah Data', $this->cssFail),Messenger::NextRequest);
      }
         //exit();
	...
	function Update() {
      ...
      $cek = true;
		if($cek === true) {
         ...
         //gagal masukin data
         //echo "gagal";
         Messenger::Instance()->Send('transaksi_realisasi_kode_jurnal', 'Transaksi', 'view', 'html', array($this->_POST,'Gagal Merubah Data Transaksi', $this->cssFail),Messenger::NextRequest);
		   return $this->pageView . '&dataId=' . $this->encId;
      }
      //echo "adflj";
		return $this->pageView;
