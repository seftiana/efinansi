...
require_once GTFWConfiguration::GetValue( 'application', 'docroot') .
			'module/history_transaksi_pencairan/business/HTPengeluaran.class.php';

class ViewHTPengeluaran extends HtmlResponse
{
	...
	public function TemplateModule()
	{
		...
		$this->SetTemplateFile('view_ht_pengeluaran.html');
	}

	public function ProcessRequest()
	{
	  $Obj = new HTPengeluaran();
	...
	public function ParseTemplate($data = NULL)
	{
		...
		if (empty($data['dataDetilTransaksi'])) {
			...
			$this->mrTemplate->AddVar('data', 'DATA_EMPTY', 'NO');
         	...
         	$label = GTFWConfiguration::GetValue('language','transaksi_pengeluaran');
         	$urlDelete = 'history_transaksi_pencairan|deleteHTPengeluaran|do|html';
         	$urlReturn = 'history_transaksi_pencairan|HTPengeluaran|view|html';
