	...
	public function ParseTemplate($data = NULL)
	{
		...
		*/
		...
		if (empty($data['dataDetilTransaksi'])) {
         ...
         $urlDelete = 'history_transaksi_pencairan|deleteHTTransaksi|do|html';
         $urlReturn = 'history_transaksi_pencairan|HTTransaksi|view|html';
         $URLDELETE = Dispatcher::Instance()->GetUrl('history_transaksi_pencairan', 'deleteHTTransaksi', 'do', 'html');
