...
'module/history_transaksi_pencairan/business/HTRealisasiPencairan.class.php';
...
class ViewHTRealisasiPencairan extends HtmlResponse
{
   ...
   public function ParseTemplate($data = NULL)
   {
      ...
      $urlPopupMak   = Dispatcher::Instance()->GetUrl(
         'history_transaksi_pencairan',
         'popupMak',
         'view',
         'html'
      ...
      $this->mrTemplate->AddVar('content', 'URL_POPUP_MAK', $urlPopupMak);
      ...
      if (empty($data['dataDetilTransaksi'])) {
         ...
         $urlDelete  = 'history_transaksi_pencairan|deleteHTRealisasiPencairan|do|html';
         $urlReturn  = 'history_transaksi_pencairan|HTRealisasiPencairan|view|html';
         $URLDELETE  = Dispatcher::Instance()->GetUrl(
            'history_transaksi_pencairan',
            'deleteHTRealisasiPencarian',
            'do',
            'html'
         );
         ...
         for ($i=0; $i<sizeof($dataDetilTransaksi); $i++) {
            ...
            $dataDetilTransaksi[$i]['url_cetak_bukti'] = Dispatcher::Instance()->GetUrl(
               'history_transaksi_pencairan',
               'FormCetakBKK',
               'view',
               'html'
