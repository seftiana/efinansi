...
require_once GTFWConfiguration::GetValue( 'application', 'docroot') .
	'module/history_transaksi_pencairan/business/transaksi_realisasi_penerimaan/AppPopupKegiatanDetil.class.php';
...
class ViewPopupKegiatanDetil extends HtmlResponse {
	...
	function TemplateModule() {
		...
		$this->SetTemplateFile('transaksi_realisasi_penerimaan/view_popup_kegiatan_detil.html');
	}
