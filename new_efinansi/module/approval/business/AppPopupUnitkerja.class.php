...
class AppPopupUnitkerja extends Database
{
   ...
   function __construct($connectionNumber=0){
      $this->mSqlFile   = 'module/approval/business/apppopupunitkerja.sql.php';
   ...
   private function setUserId()
   {
      if(class_exists('Security')){
         $this->mUser   = Security::Instance()->mAuthentication->GetCurrentUser()->GetUserId();
      }
   }
   ...
   public function getUserId()
   {
      ...
      return (int)$this->mUser;
   }

   public function GetDataTipeUnit()
   {
