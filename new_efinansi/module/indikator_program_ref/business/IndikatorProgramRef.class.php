...
class IndikatorProgramRef extends Database
{
    
    protected $mSqlFile= 'module/indikator_program_ref/business/indikatorprogramref.sql.php';
    protected $mUserId;
    ...
    public function GetData($kode,$nama,$ipId,$startRec,$itemViewed)
    {
        if($ipId ==''){
            $ipId ='%%';
        }
    ...
    public function GetDataCount($kode,$nama,$ipId)
    {
        if($ipId ==''){
            $ipId ='%%';
        }
