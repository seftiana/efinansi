...
/**
* ================= doc ====================
* FILENAME     : ViewEditSubAccountKelima.html.class.php
* @package     : ViewEditSubAccountKelima
* scope        : PUBLIC
* @Author      : Eko Susilo
* @Created     : 2015-02-18
* @Modified    : 2015-02-18
...
class ViewEditSubAccountKelima extends HtmlResponse
{
   function TemplateModule(){
      $this->SetTemplateBasedir(GTFWConfiguration::GetValue('application','docroot').
      'module/sub_account_kelima/template/');
      $this->SetTemplateFile('view_edit_sub_account_kelima.html');
   }
