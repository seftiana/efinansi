<?php
class AppLapMonitoringAnggaran extends Database
{
   protected $mSqlFile;
   public $_POST;
   public $_GET;
   ...
   function __construct($connectionNumber=0) {
      $this->mSqlFile   = 'module/lap_monitoring_anggaran/business/applapmonitoringanggaran.sql.php';
   ...
   function GetData($offset, $limit, $param = array()){
      $return     = $this->Open($this->mSqlQueries['get_data'], array(
         ...
         (int)$param['bulan'],
         (int)($param['bulan'] == '' OR $param['bulan'] === NULL OR strtolower($param['bulan']) == 'all'),
   ...
   function GetUnitIdentity($id){
      $return     = $this->Open($this->mSqlQueries['get_unit_kerja_id'],array(
         $id
      ));
      return $return[0];
   }
   ...
   function GetProgramById($id) {
      $result     = $this->Open($this->mSqlQueries['get_program_by_id'], array(
         $id
      ));
      return $result[0];
   }
