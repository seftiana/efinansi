    ...
    public function getDataLaporan($param = array()) {
        ...
        if(!empty($return)){
            ...
            foreach ($return as $itemData) {
                ...
                if(!array_key_exists($itemData['kellap_id'], $saveArrayId)){
                    $saveArrayId[$itemData['kellap_id']] = $index;
                    $index++;
                }
                if(array_key_exists($itemData['kellap_id'], $saveArrayId)){
                    $dataLaporan[$saveArrayId[$itemData['kellap_id']]]['kellap_jns_id'] = $itemData['kellap_jns_id'];
                    $dataLaporan[$saveArrayId[$itemData['kellap_id']]]['kellap_jns_nama'] = $itemData['kellap_jns_nama'];
                    $dataLaporan[$saveArrayId[$itemData['kellap_id']]]['kellap_id'] = $itemData['kellap_id'];
                    $dataLaporan[$saveArrayId[$itemData['kellap_id']]]['kellap_nama'] = $itemData['kellap_nama'];
                    ...
                    $dataLaporan[$saveArrayId[$itemData['kellap_id']]]['nominal'] += $saldo;                    
                }
            }
        } 
        return $dataLaporan;
