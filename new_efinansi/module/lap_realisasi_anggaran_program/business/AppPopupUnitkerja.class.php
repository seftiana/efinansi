...
class AppPopupUnitkerja extends Database
{
   ...
   function __construct($connectionNumber=0)
   {
      ...
      $this->mSqlFile   = 'module/'.Dispatcher::Instance()->mModule.'/business/apppopupunitkerja.sql.php';
   ...
   {
      $unitKerja        = $this->mUnitObj->GetUnitKerjaUser($this->mUserId);
