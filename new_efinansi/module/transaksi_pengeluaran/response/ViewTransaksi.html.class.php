...
require_once GTFWConfiguration::GetValue( 'application', 'docroot') . 
		'module/transaksi_pengeluaran/business/AppTransaksi.class.php';
require_once GTFWConfiguration::GetValue( 'application', 'docroot') . 
...
class ViewTransaksi extends HtmlResponse 
{
	...
	public function TemplateModule() 
	{
		$this->SetTemplateBasedir(GTFWConfiguration::GetValue('application','docroot').
			'module/transaksi_pengeluaran/template');
	...
	public function ParseTemplate($data = NULL) 
	{
		...
		$this->mrTemplate->AddVar('content','NAME_TIPE_TRANSAKSI',$data['tipe_transaksi'][0]['name']);
      	$url_view = Dispatcher::Instance()->GetUrl('transaksi_pengeluaran', 'transaksi', 'view', 'html');
