...
//mulai bikin tombol delete
			...
			$urlDelete = Dispatcher::Instance()->GetUrl('jurnal_kode', 'deleteKodeJurnal', 'do', 'html');
			$urlReturn = Dispatcher::Instance()->GetUrl('jurnal_kode', 'kodeJurnal', 'view', 'html');
...
//selesai bikin tombol delete
			...
			for ($i=0; $i<sizeof($dataKodeJurnal); $i++) {
				...
				if($dataKodeJurnal[$i]['status_aktif']=='N'){
					$dataKodeJurnal[$i]['status_aktif']='T';
				}				
				...
				$dataKodeJurnal[$i]['url_edit'] = Dispatcher::Instance()->GetUrl('jurnal_kode', 'inputKodeJurnal', 'view', 'html') . '&dataId=' . $idEnc . '&page=' . $encPage . '&cari='.$cari;
				$dataKodeJurnal[$i]['url_detil'] = Dispatcher::Instance()->GetUrl('jurnal_kode', 'detilKodeJurnal', 'view', 'html') . '&dataId=' . $idEnc;
