...
class ViewDetailTransaksi extends HtmlResponse
{
   ...
   function ProcessRequest(){
      ...
      $dataKomponenAnggaran = $mObj->getKomponenAnggaranByTransId($transId);
      ...
      $return['komponen_anggaran']  = $dataKomponenAnggaran;
   ...
   function ParseTemplate($data = null){
      ...
      $dataKomponenAnggaran =$data['komponen_anggaran'];
