...
/**
 * class ViewSubAccountKeempat
 * untuk menangani tampilan sub account keempat
 * @access public
 */
class ViewSubAccountKeempat extends HtmlResponse
{
   public function TemplateModule()
   {
      $this->SetTemplateBasedir(GTFWConfiguration::GetValue('application','docroot').
         'module/sub_account_keempat/template');
      $this->SetTemplateFile('view_sub_account_keempat.html');
   }
   ...
   public function ParseTemplate($data = NULL)
   {
      ...
      $label      = "Kode Sub Account Keempat";
      $urlDelete  = Dispatcher::Instance()->GetUrl(
         'sub_account_keempat',
         'deleteSubAccountKeempat',
         'do',
         'html'
      ).'&'.$queryString;
