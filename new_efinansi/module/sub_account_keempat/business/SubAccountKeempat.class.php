 ...
 */
 ...
 /**
  * Class SubAccountKeempat
  * @todo Untuk menghandle manipulasi data dalam tabel finansi_keu_ref_subacc_1
  */
class SubAccountKeempat extends Database
{
   protected $mSqlFile;
   public $_POST;
   public $_GET;
   ...
   {
      $this->mSqlFile   = 'module/sub_account_keempat/business/sub_account_keempat.sql.php';
   ...
   {
      return $this->Execute($this->mSqlQueries['do_add_sub_account_keempat'], array(
         $subAccKode,
         $subAccNama
      ));
   }
   ...
   {
      return $this->Execute($this->mSqlQueries['do_update_sub_account_keempat'],
   ...
   {
      return $this->Execute($this->mSqlQueries['do_delete_sub_account_keempat'], array($subAccKode));
   }
