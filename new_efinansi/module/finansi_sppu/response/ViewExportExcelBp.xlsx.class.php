...
class ViewExportExcelBp extends XlsxResponse
{
   ...
   function ProcessRequest()
   {
	  ...
	  $sheet->setCellValue('G1', 'KODE DOKUMEN : F-KUA-001.04'); #
      ...
      $sheet->setCellValue('H2', $dataTransBank['nomor_bp']); #
