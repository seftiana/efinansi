...
class ViewSppu extends HtmlResponse
{
   ...
   function ProcessRequest(){      
      ...
      $return['get_is_onload']   = $isOnLoad;
      $return['get_cookie']      = json_encode($cookieSPPU->get());
      return $return;
   }
   ...
   function ParseTemplate($data = null){
      ...
      $this->mrTemplate->AddVar('content', 'GET_COOKIE', $data['get_cookie']);
      $this->mrTemplate->AddVar('content', 'IS_ON_LOAD', $data['get_is_onload']);
