<?php
require_once GTFWConfiguration::GetValue( 'application', 'docroot') . 'module/transaksi_kode_jurnal_penerimaan/business/AppPopupSkenario.class.php';
...
//combo jenis
	...
	function ParseTemplate($data = NULL) {
      ...
      if($data['search']['jenis'] == "auto") {
		...
		$this->mrTemplate->AddVar('content', 'URL_SEARCH', Dispatcher::Instance()->GetUrl('transaksi_kode_jurnal', 'popupSkenario', 'view', 'html'));
		if($this->Pesan) {
