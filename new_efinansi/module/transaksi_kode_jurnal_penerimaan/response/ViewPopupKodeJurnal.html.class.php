<?php
require_once GTFWConfiguration::GetValue( 'application', 'docroot') . 'module/transaksi_kode_jurnal_penerimaan/business/KodeJurnal.class.php';
...
class ViewPopupKodeJurnal extends HtmlResponse {
	...
	function ParseTemplate($data = NULL) {
	   ...
	   $this->mrTemplate->AddVar('content', 'URL_SEARCH', Dispatcher::Instance()->GetUrl('transaksi_kode_jurnal_penerimaan', 'popupKodeJurnal', 'view', 'html'));
...
//mulai bikin tombol delete
			...
			$urlDelete = Dispatcher::Instance()->GetUrl('transaksi_kode_jurnal_penerimaan', 'deleteKodeJurnal', 'do', 'html');
			$urlReturn = Dispatcher::Instance()->GetUrl('transaksi_kode_jurnal_penerimaan', 'kodeJurnal', 'view', 'html');
