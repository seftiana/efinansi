<?php
require_once GTFWConfiguration::GetValue( 'application', 'docroot') . 'module/transaksi_penerimaan/business/AppPopupKegiatanDetil.class.php';
...
class ViewPopupSisaAnggaran extends HtmlResponse {
	...
	function ParseTemplate($data = NULL) {
		...
		$this->mrTemplate->AddVar('content', 'URL_SEARCH', Dispatcher::Instance()->GetUrl('transaksi_penerimaan', 'popupKegiatanDetil', 'view', 'html') . '&unitkerja=' . $this->encUnitkerjaId);
		if($this->Pesan) {
