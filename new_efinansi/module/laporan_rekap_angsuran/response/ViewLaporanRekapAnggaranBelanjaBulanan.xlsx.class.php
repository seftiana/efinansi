...
class ViewLaporanRekapAnggaranBelanjaBulanan extends XlsxResponse
{
   ...
   function ProcessRequest()
   {
      ...
      $requestData['pinjaman']    = Dispatcher::Instance()->Decrypt($mObj->_GET['pinjaman']);
      ...
      $pinjaman      = GTFWConfiguration::GetValue('language', 'pinjaman');
	  ...
	  $sheet->setCellValue('F6', $pinjaman);
      $sheet->setCellValue('G7', $bulan);
      $rMon       = 7;
      $cMon       = 5;
      ...
      $sheet->setCellValueByColumnAndRow($cMon, 6, 'TOTAL ANGSURAN ');
