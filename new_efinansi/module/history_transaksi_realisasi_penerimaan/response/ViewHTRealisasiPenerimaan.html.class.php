...
'module/history_transaksi_realisasi_penerimaan/business/HTRealisasiPenerimaan.class.php';
...
class ViewHTRealisasiPenerimaan extends HtmlResponse
{
   ...
   public function ParseTemplate($data = NULL)
   {
      ...
      if (empty($data['dataHTRealisasiPenerimaan'])) {
         ...
         $urlDelete = 'history_transaksi_realisasi_penerimaan|deleteHTRealisasiPenerimaan|do|html';
         $urlReturn = 'history_transaksi_realisasi_penerimaan|HTRealisasiPenerimaan|view|html';
         ...
         for ($i=0; $i<sizeof($dataHTRealisasiPenerimaan); $i++) {
            ...
            if($dataHTRealisasiPenerimaan[$i]['tipe_id'] == 1) {
               ...
               $dataHTRealisasiPenerimaan[$i]['label_cetak_bukti'] = 'Export BKM';
            ...
            $dataHTRealisasiPenerimaan[$i]['nominal_label'] = number_format($dataHTRealisasiPenerimaan[$i]['nominal'], 2, ',', '.');

            $dataHTRealisasiPenerimaan[$i]['url_cetak'] = Dispatcher::Instance()->GetUrl(
               'history_transaksi_realisasi_penerimaan',
               'FormCetakTransaksi',
               'view',
               'html'
            ...
            $dataHTRealisasiPenerimaan[$i]['url_cetak_rtf'] = Dispatcher::Instance()->GetUrl(
               'history_transaksi_realisasi_penerimaan',
               'rtfSSBP',
               'print',
               'rtf'
