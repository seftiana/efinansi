...
class DoCetakTransaksi extends XlsxResponse
{
   ...
   function ProcessRequest()
   {
      ...
      $this->SetFileName('kuitansi_pembayaran.xls');
      ...
      # set worksheet name
      $sheet->setTitle('Bukti Pembayaran');
      # set font default
      ...
      $sheet->setCellValue('D11', ($dataList['keterangan'] == '') ? $dataList['map_nama'] : $dataList['keterangan']);
