...
require_once GTFWConfiguration::GetValue( 'application', 'docroot') . 
		'module/history_transaksi/business/transaksi/AppPopupSkenario.class.php';
...
//combo jenis
	...
	function ParseTemplate($data = NULL) {
      ...
      if($data['search']['jenis'] == "auto") {
		...
		$this->mrTemplate->AddVar('content', 'URL_SEARCH', Dispatcher::Instance()->GetUrl('history_transaksi', 'popupSkenario', 'view', 'html'));
		if($this->Pesan) {
