...
require_once GTFWConfiguration::GetValue( 'application', 'docroot') . 
	'module/rincian_perhitungan_rencana_penerimaan/business/AppPopupUnitkerja.class.php';
require_once GTFWConfiguration::GetValue( 'application', 'docroot') . 
...
class ViewPopupUnitkerja extends HtmlResponse 
{
	...
	function ParseTemplate($data = NULL) {
		...
		$this->mrTemplate->AddVar('content', 'URL_SEARCH', Dispatcher::Instance()->GetUrl('rencana_penerimaan', 'popupUnitkerja', 'view', 'html') . "&satker=" . Dispatcher::Instance()->Encrypt($search['satker']));
		if($this->Pesan) {
