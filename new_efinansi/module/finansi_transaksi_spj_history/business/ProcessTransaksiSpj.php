...
class ProcessTransaksiSpj
{
   ...
   {
      $this->mObj       = new HistoryTransaksiSpj($connetionNumber);
   ...
   {
      $return['url']    = $this->urlDetail;
      $return['data']   = null;
      if($this->mObj->method == 'post'){
         $transaksiId   = $this->mObj->_POST['idDelete'];
         $process       = $this->mObj->doDeleteTransaksi($transaksiId);
         if($process === true){
