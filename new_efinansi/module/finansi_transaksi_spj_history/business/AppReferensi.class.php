...
class AppReferensi extends Database
{
   ...
   {
      $this->mSqlFile   = 'module/finansi_transaksi_spj_history/business/app_referensi.sql.php';
   ...
   public function getDataReferensiRealisasi($offset, $limit, $param = array())
   {
      $return     = $this->Open($this->mSqlQueries['get_data_referensi_realisasi'], array(
         $param['unit_id'],
         (int)($param['unit_id'] === NULL OR $param['unit_id'] == ''),
         '%'.$param['kode'].'%',
         '%'.$param['nama'].'%',
         $offset,
         $limit
