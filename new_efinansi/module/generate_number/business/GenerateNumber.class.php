...
class GenerateNumber extends Database {
    ...
    /**
     * getNomorLppa
     * @description untuk menggerate nomor LPPA
     * @param date $tanggal
     * @return string
     */
    public function getNomorLppa($tanggal) { 
        $label1 = 'LPPA';
        $label2 = 'KEU';
        $result = $this->Open($this->mSqlQueries['get_nomor_lppa'], array(
            $label1,
            $label2,
            $tanggal,
            $tanggal,
