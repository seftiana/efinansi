 ...
 */
 ...
 /**
  * Class SubAccountKetujuh
  * @todo Untuk menghandle manipulasi data dalam tabel finansi_keu_ref_subacc_7
  */
class SubAccountKetujuh extends Database
{
   protected $mSqlFile;
   public $_POST;
   public $_GET;
   ...
   {
      $this->mSqlFile   = 'module/sub_account_ketujuh/business/sub_account_ketujuh.sql.php';
   ...
   {
      return $this->Execute($this->mSqlQueries['do_add_sub_account_ketujuh'], array(
         $subAccKode,
         $subAccNama
      ));
   }
   ...
   {
      return $this->Execute($this->mSqlQueries['do_update_sub_account_ketujuh'],
   ...
   {
      return $this->Execute($this->mSqlQueries['do_delete_sub_account_ketujuh'], array($subAccKode));
   }
