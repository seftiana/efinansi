<?php
/**
 * class ViewInputSubAccountKetujuh
...
/**
 * class ViewInputSubAccountKetujuh
 * untuk menangani tampilan input sub account ketujuh
 * @access public
 */
class ViewInputSubAccountKetujuh extends HtmlResponse
{
   public function TemplateModule()
   {
      $this->SetTemplateBasedir(GTFWConfiguration::GetValue('application', 'docroot').
         'module/sub_account_ketujuh/template');
      $this->SetTemplateFile('input_sub_account_ketujuh.html');
   }
