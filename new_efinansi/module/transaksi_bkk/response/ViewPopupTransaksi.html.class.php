...
class ViewPopupTransaksi extends HtmlResponse
{
   ...
   function TemplateModule ()
   {
      ...
      $this->SetTemplateFile('view_popup_transaksi.html');
   }
   ...
   function ProcessRequest ()
   {
      ...
      if (isset($_GET['transReferensi'])) $filter = $_GET->AsArray();
      elseif (isset($_POST['btncari'])) $filter = $_POST->AsArray();
      ...
      $return['dataGrid'] = $Obj->GetTransaksiListBySearch($filter, $startRec, $itemViewed);
   ...
   {  
      ...
      foreach ($data['dataGrid'] as $item)
      {
         ...
         $item['transNilaiLabel'] = number_format($item['transNilai'], 2, '.', ',');
