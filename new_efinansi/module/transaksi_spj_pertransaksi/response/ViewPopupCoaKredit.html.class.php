...
require_once GTFWConfiguration::GetValue( 'application', 'docroot').
   'module/transaksi_spj_pertransaksi/business/AppPopupCoaKredit.class.php';

class ViewPopupCoaKredit extends HtmlResponse
{
   ...
   function TemplateModule()
   {
      ...
      $this->SetTemplateFile('view_popup_coa_kredit.html');
   }
   ...
   function ProcessRequest()
   {
      ...
      $return['url']['search'] = Dispatcher::Instance()->GetUrl('transaksi_spj_pertransaksi','popupCoaKredit','view','html');
      // ---------
   ...
   {
      #print_r($data);
       $this->mrTemplate->AddVar('content', 'URL_SEARCH', Dispatcher::Instance()->GetUrl('transaksi_spj_pertransaksi', 'popupCoaKredit', 'view', 'html'));
