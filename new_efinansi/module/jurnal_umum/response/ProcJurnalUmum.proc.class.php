<?php
require_once GTFWConfiguration::GetValue('application', 'docroot') . 'module/jurnal_umum/business/JurnalUmum.class.php';

class ProcJurnalUmum
{
	...
	public $moduleName = 'jurnal_umum';
	
	public $moduleHome = 'jurnalUmum';
	
	public $moduleInput = 'inputJurnalUmum';
	
	public $moduleAdd = 'addJurnalUmum';
	
	public $moduleUpdate = 'updateJurnalUmum';
	
	public $moduleDelete = 'deleteJurnalUmum';
	
	private $totalValue;
	
	public $db; //yang berhubungan ke database

	function ProcJurnalUmum() 
	{ //constructor

		$this->db = new JurnalUmum;
	...
	function validation($action) 
	{
		...
		if ($this->msg == '') 
		{
			...
			//if (trim($this->data['referensi_id']) == '') 
				$this->totalValue = $total_all_debet;
