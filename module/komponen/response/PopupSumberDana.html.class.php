...
class PopupSumberDana extends HtmlResponse {
	...
	function TemplateModule()
   {
		...
		$this->SetTemplateFile('popup_sumber_dana.html');
	}
   ...
   function ProcessRequest() {
	...
	function ParseTemplate($data = NULL) {
		...
		$this->mrTemplate->AddVar('content', 'URL_SEARCH', Dispatcher::Instance()->GetUrl(Dispatcher::Instance()->mModule, 'SumberDana', 'popup', 'html'));
