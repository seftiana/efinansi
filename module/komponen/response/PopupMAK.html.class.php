<?php
require_once GTFWConfiguration::GetValue('application', 'docroot').'module/'.Dispatcher::Instance()->mModule.'/business/Komponen.class.php';

class PopupMAK extends HtmlResponse {
	...
	function TemplateModule()
   {
		...
		$this->SetTemplateFile('popup_mak.html');
	}
   ...
   function ProcessRequest() {
		...
		$totalData = $kodeObj->GetCountKodeMAK($namaMak);		
		$itemViewed = 20;
		$currPage = 1;
		$startRec = 0 ;
		...
		$dataList = $kodeObj->GetDataKodeMAK($startRec, $itemViewed, $namaMak);
	...
	function ParseTemplate($data = NULL) {
		...
		$this->mrTemplate->AddVar('content', 'URL_SEARCH', Dispatcher::Instance()->GetUrl(Dispatcher::Instance()->mModule, 'MAK', 'popup', 'html'));
