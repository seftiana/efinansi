...
class AppLapRekapProgram extends Database
{
   ...
   {
      $this->mSqlFile   = 'module/lap_realisasi_anggaran_program/business/applaprekapprogram.sql.php';
   ...
   function GetData($offset, $limit, $param = array())
   {
      $return        = $this->Open($this->mSqlQueries['get_data'], array(
         ...
         $param['bulan'],
         (int)($param['bulan'] == '' OR $param['bulan'] == '0' OR strtolower($param['bulan']) == 'all'),
   ...
   function GetResume($periode, $program='', $jenis_kegiatan='', $unitkerja='', $bulan)
    {
//$this->SetDebugOn();
   ...
   function GetResumeKegiatan($periode, $program='', $jenis_kegiatan='', $unitkerja='',$bulan)
    {
      if($jenis_kegiatan != 'all' && $jenis_kegiatan != '')
            $str_jenis_kegiatan=" AND d.subprogJeniskegId=$jenis_kegiatan ";
      else
