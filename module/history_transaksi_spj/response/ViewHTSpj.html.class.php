...
require_once GTFWConfiguration::GetValue( 'application', 'docroot') . 
				'module/history_transaksi_spj/business/HTSpj.class.php';

class ViewHTSpj extends HtmlResponse 
{
	...
	public function TemplateModule() 
	{
		$this->SetTemplateBasedir(GTFWConfiguration::GetValue('application','docroot') .
					'module/history_transaksi_spj/template');
		$this->SetTemplateFile('view_ht_spj.html');
	}
	...
	//view
		...
		$url = Dispatcher::Instance()->GetUrl(
										...
										'&nomor_bukti=' . Dispatcher::Instance()->Encrypt($mak_nama) .
	...
	public function ParseTemplate($data = NULL) 
	{
		...
		if (empty($data['dataDetilTransaksi'])) {
			...
			$this->mrTemplate->AddVar('data', 'DATA_EMPTY', 'NO');
         	...
         	$label = 'Transaksi';
         	$urlDelete = 'history_transaksi_spj|deleteTransaksi|do|html';
         	$urlReturn = 'history_transaksi_spj|HTSpj|view|html';
         	$URLDELETE = Dispatcher::Instance()->GetUrl('history_transaksi_spj', 
			 											'deleteTransaksi', 'do', 'html');
            ...
            #peneriman / bkm
            	if($dataDetilTransaksi[$i]['tipe_id'] == 1) {
					...
					$dataDetilTransaksi[$i]['url_cetak_bukti'] = '';
					$dataDetilTransaksi[$i]['label_cetak_bukti'] = '';
					$dataDetilTransaksi[$i]['display'] = 'style="display:none;"';
				}
