...
/**
 * 
 * class LapUnitCostPerOutput
 * @package lap_unit_cost_per_output
...
class LapUnitCostPerOutput extends Database
{
	 protected $mSqlFile= 'module/lap_unit_cost_per_output/business/lapunitcostperoutput.sql.php';
