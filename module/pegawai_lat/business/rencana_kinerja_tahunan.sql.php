...
INSERT INTO bulan_angsuran_detail
SET kegdetKegId = '%s',
   kegdetKegrefId = '%s',
...
$sql['get_last_id']   = "
SELECT MAX(kegId) AS last_id FROM bulan_angsuran
";

// add detil kegiatan
$sql['do_add_detil_usulan_kegiatan']    = "
INSERT INTO bulan_angsuran_detail SET kegdetKegId = '%s',
kegdetKegrefId = '%s',
kegdetDeskripsi = '%s',
kegdetCatatan = '%s',
kegdetOutPut = '%s',
...
UPDATE bulan_angsuran_detail SET kegdetKegId = '%s',
kegdetKegrefId = '%s',
kegdetDeskripsi = '%s',
kegdetCatatan = '%s',
kegdetOutPut = '%s',
...
FROM
   bulan_angsuran_detail AS kd
   JOIN bulan_angsuran AS k
      ON (k.kegId = kd.kegdetKegId)
   JOIN unit_kerja_ref AS ukr
      ON ukr.`unitkerjaId` = k.`kegUnitkerjaId`
   JOIN program_ref p
