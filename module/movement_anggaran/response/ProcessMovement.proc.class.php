    ...
    class Movement 
    {
        ...
        function Movement()
        {
            ...
            if($check === true and isset($this->data['save'])){
                ...
                $add_apbnp  = $this->obj->InsertIntoHistoryMovement($this->data);
                
                # jika proses apbnp berhasil
                if($add_apbnp){
                   
                        # jika semua proses berjalan dengan baik
                        $pesan  = 'Process Revisi Interen berhasil di laksanakan';
                        Messenger::Instance()->
                        Send(
                            'movement_anggaran',
                            'movementAnggaran',
        ...
        function replace($nominal){
            $replace    = str_replace('.','',$nominal);
