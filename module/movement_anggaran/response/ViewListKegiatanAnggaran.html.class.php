...
*/
    ...
    'module/movement_anggaran/business/AppKegiatan.class.php';

    class ViewListKegiatanAnggaran extends HtmlResponse{
        public $objKegiatan;
        public $POST;
        public $data;
        public $Pesan;
        ...
        function TemplateModule(){
            ...
            $this->setTemplateFile('view_list_kegiatan_anggaran.html');
        }
        ...
        function ProcessRequest(){
            ...
            $unit_id       = Dispatcher::Instance()->Decrypt($this->objKegiatan->_GET['unit_id']);
            $unit_nama     = Dispatcher::Instance()->Decrypt($this->objKegiatan->_GET['unit_nama']);
            // var_dump($unit_id);
 ...
 # Combobox
      Messenger::Instance()->SendToComponent(
         ...
         Messenger::CurrentRequest
		    ...
		    $komponen_anggaran          = $this->objKegiatan->GetKomponenAnggaran($dataKegiatanRef);
        ...
        function ParseTemplate($data = null){
            ...
            $url_search = Dispatcher::Instance()->GetUrl('movement_anggaran', 'ListKegiatanAnggaran', 'view', 'html').
                          '&unit_id=' . $data['unit_id'].'&unit_nama=' . $data['unit_nama'];
                          //.'&mak_id='.Dispatcher::Instance()->Decrypt($_GET['mak_id']);
            ...
            $this->mrTemplate->AddVar('content', 'UNIT_KERJA_ID', $data['unit_id']);
            $this->mrTemplate->AddVar('content', 'UNIT_KERJA_NAMA', $data['unit_nama']);
		    ...
		    else 
		    {
                ...
                for ($i=0; $i<sizeof($dataKegiatanRef); $i++)
                {
                    ...
                    //jika total anggaran sudah direalisasikan semua maka tidak dapat menyusun 
                    ...
                    $dataKegiatanRef[$i]['total_available'] = number_format(($dataKegiatanRef[$i]['total_anggaran'] - $dataKegiatanRef[$i]['total_realisasi']), 0, ',', '.');
