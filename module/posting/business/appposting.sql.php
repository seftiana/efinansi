...
SELECT
   ...
   CONCAT_WS('-', TRIM(BOTH FROM bbhisSubaccPertamaKode),
   ...
   TRIM(BOTH FROM bbhisSubaccKetujuhKode)) AS subAccount
FROM buku_besar_his
...
SELECT
   ...
   CONCAT_WS('-', TRIM(BOTH FROM pdSubaccPertamaKode),
   ...
   TRIM(BOTH FROM pdSubaccKetujuhKode)) AS subAccount
...
jurnal.tanggalPembukuan DESC, SUBSTRING_INDEX(jurnal.referensi, '/', 2) DESC,
pdStatus ASC
";
...
SELECT
   ...
   CONCAT_WS('-', bbSubaccPertamaKode,
   bbSubaccKeduaKode,
   bbSubaccKetigaKode,
   bbSubaccKeempatKode,
   bbSubaccKelimaKode,
   bbSubaccKeenamKode,
   bbSubaccKetujuhKode) AS sub_akun
FROM
   buku_besar
