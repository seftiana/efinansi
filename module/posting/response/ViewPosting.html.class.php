...
class ViewPosting extends HtmlResponse {
    ...
    function ProcessRequest() {
        ...
        $dateParameter = $Obj->getParameterDate($requestData['sub_account']);
        $requestData['last_posting'] = $dateParameter['last_posting'];
        $requestData['last_transaksi'] = $dateParameter['last_transaksi'];
        $dataJurnalDueDate = $Obj->getJurnalDueDate($requestData['last_posting'], $requestData['last_transaksi'],$requestData['sub_account']);
        $countJurnalDueDate = $Obj->countJurnalDueDate($requestData['last_posting'], $requestData['last_transaksi']);
        $statePosting = $Obj->getStatePosting($requestData['sub_account']);
        $dataJurnal = $Obj->getJurnalPembukuan(
                $requestData['last_posting'], $requestData['last_transaksi'],$requestData['sub_account']
        );
