...
/**
* ================= doc ====================
* FILENAME     : ViewPopupReferensiKegiatan.html.class.php
* @package     : ViewPopupReferensiKegiatan
* scope        : PUBLIC
* @Author      : Eko Susilo
* @Created     : 2015-04-24
* @Modified    : 2015-04-24
...
'module/finansi_transaksi_spj_history/business/AppReferensi.class.php';

class ViewPopupReferensiKegiatan extends HtmlResponse
{
   function TemplateModule(){
      $this->SetTemplateBasedir(GTFWConfiguration::GetValue('application','docroot').
      'module/finansi_transaksi_spj_history/template/');
      $this->SetTemplateFile('view_popup_referensi_kegiatan.html');
   }
   ...
   function ProcessRequest(){
      ...
      $dataList         = $mObj->getDataReferensiRealisasi($offset, $limit, (array)$requestData);
