...
$sql['get_buku_besar_as_tahun_pembukuan'] = "
   SELECT
      ...
      coaIsLocked,
      coaIsDebetPositif,
      IF( bbh.bbPdId IS NULL AND bbh.bbPembukuanRefId IS NULL ,bbh.bbSaldo,bbSaldoAwal) AS saldo_awal,
      ...
      (IF( bbh.bbPdId IS NULL AND bbh.bbPembukuanRefId IS NULL ,bbh.bbSaldo,bbSaldoAwal) +  SUM(IF( bbh.bbPdId IS NULL AND bbh.bbPembukuanRefId IS NULL ,0,bbh.bbSaldo))) AS saldo_akhir 
      [SUBACC_VIEW]
   FROM 
      buku_besar_his bbh 
      JOIN coa c ON(c.coaId= bbh.bbCoaId)
