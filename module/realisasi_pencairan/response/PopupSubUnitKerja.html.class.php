<?php
require_once GTFWConfiguration::GetValue( 'application', 'docroot') . 'module/realisasi_pencairan/business/AppPopupSubUnitKerja.class.php';
...
class PopupSubUnitkerja extends HtmlResponse {
	...
	function ParseTemplate($data = NULL) {
		...
		$this->mrTemplate->AddVar('content', 'URL_SEARCH', Dispatcher::Instance()->GetUrl('realisasi_pencairan', 'subUnitKerja', 'popup', 'html') . "&satker=" . Dispatcher::Instance()->Encrypt($search['satker']) . "&satker_label=" . Dispatcher::Instance()->Encrypt($search['satker_label']));
		if($this->Pesan) {
