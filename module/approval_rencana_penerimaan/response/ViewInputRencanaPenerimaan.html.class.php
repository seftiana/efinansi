...
class ViewInputRencanaPenerimaan extends HtmlResponse {
    ...
    function ProcessRequest() {
        ...
        if (isset($_REQUEST['dataId'])) {
            ...
            Messenger::Instance()->SendToComponent('combobox', 'Combobox', 'view', 'html', 'approval', array('approval', $arr_approval, $data[0]['approval'], false, ' style="width:150px;" id="approval"'), Messenger::CurrentRequest);
