...
require_once GTFWConfiguration::GetValue( 'application', 'docroot') . 'module/transaksi_spj_pertransaksi/business/AppPopupRefTransaksi.class.php';
...
class ViewPopupRefTransaksi extends HtmlResponse {
   ...
   function ParseTemplate($data = NULL) {      
      ...
      $this->mrTemplate->AddVar('content', 'URL_SEARCH', Dispatcher::Instance()->GetUrl('jurnal_pengeluaran', 'referensiTransaksi', 'popup', 'html').'&tipe='.$data['tipe'] );      	  
