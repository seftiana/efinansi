<?php
#doc
#    classname:    AppPopupSubkegiatan
#    scope:        PUBLIC
#
#/doc
class AppPopupSubkegiatan extends Database
{
   #    internal variables
   protected $mSqlFile;
   public $_POST;
   ...
   {
      $this->mSqlFile   = 'module/rencana_kinerja_tahunan_kegiatan/business/app_popup_subkegiatan.sql.php';
      $this->_POST      = is_object($_POST) ? $_POST->AsArray() : $_POST;
      $this->_GET       = is_object($_GET) ? $_GET->AsArray() : $_GET;
      parent::__construct($connectionNumber);
   }

   public function getPeriodeTahun($id)
   {
   ...
   ###
   function GetDataProgram($ta_id){
      $return     = $this->Open($this->mSqlQueries['get_program'], array($ta_id));
      return $return;
   }
