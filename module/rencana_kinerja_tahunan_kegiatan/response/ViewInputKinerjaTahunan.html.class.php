<?php
#doc
#    classname:    ViewInputKinerjaTahunan
#    scope:        PUBLIC
#
#/doc
...
class ViewInputKinerjaTahunan extends HtmlResponse
{
   function TemplateModule()
   {
      ...
      $this->SetTemplateFile('view_input_rencana_kinerja_tahunan.html');
   }
   ...
   function ProcessRequest()
   {
      ...
      $requestData['end_date']   = date('Y-m-t', strtotime($requestData['start_date']));
      $requestData['nama_pic']   = Security::Instance()->mAuthentication->GetCurrentUser()->GetRealName();
	 ...
	 $requestData['jenis_rpc']           = $messengerData['jenis_rpc']; #add ccp 28-11-2019
      ...
      #add ccp combo jenis_rpc RPC 28-11-2019
      Messenger::Instance()->SendToComponent(
         'combobox',
         'Combobox',
         'view',
