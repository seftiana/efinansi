...
class ViewEditJurnalUmum extends HtmlResponse
{
   function TemplateModule(){
      $this->SetTemplateBasedir(GTFWConfiguration::GetValue('application','docroot').
      'module/jurnal_umum/template/');
      $this->SetTemplateFile('view_edit_jurnal_umum.html');
   }
   ...
   function ProcessRequest(){
      ...
      $arrKategoriJurnal   = $mObj->GetKategoriJurnal();
      $arrAtribut = $mObj->getSubAccountCombo();
      $jurnalDebet         = array();
      $jurnalKredit        = array();
      $requestData         = array();
      $index               = 0;
      ...
      $requestData['kategori_jurnal']  = $dataJurnalDetil['kategori_jurnal'];
      $requestData['atribut'] = $jurnal['sub_account'];
      if($messenger){
         ...
         $requestData['kategori_jurnal'] = $messengerData['kategori_jurnal'];
         $requestData['atribut'] = $messengerData['atribut'];
      ...
      Messenger::Instance()->SendToComponent(
         ...
         array(
            'kategori_jurnal',
            $arrKategoriJurnal,
            $requestData['kategori_jurnal'],
            'false',
            'id="cmb_kategori_jurnal"'
         ),
         Messenger::CurrentRequest
      );
      ...
      Messenger::Instance()->SendToComponent(
         ...
         array(
            ...
            $requestData['atribut'],
            'false',
            'id="cmb_atribut" onchange="setAtributCoa(this)"'
         ),
         Messenger::CurrentRequest
      );
