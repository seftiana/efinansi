...
require_once GTFWConfiguration::GetValue( 'application', 'docroot') . 'module/jurnal_umum/business/AppReferensiTransaksi.class.php';
...
class PopupReferensiTransaksi extends HtmlResponse {
   ...
   function ParseTemplate($data = NULL) {      
      ...
      $this->mrTemplate->AddVar('content', 'URL_SEARCH', Dispatcher::Instance()->GetUrl('jurnal_umum', 'referensiTransaksi', 'popup', 'html').'&tipe='.$data['tipe'] );      	  
