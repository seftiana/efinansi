...
class JurnalUmum extends Database
{
   ...
   public function GetKategoriJurnal(){
      return $this->open($this->mSqlQueries['get_kategori_jurnal'], array());
   }
   ...
   public function doSaveJurnal($param = array())
   {
      ...
      $kodeKategoriArr = $this->Open($this->mSqlQueries['get_kategori_jurnal_by_id'], array($param['kategori_jurnal']));
      $kodeKategori = $kodeKategoriArr[0]['kode'];
      ...
      $queryLog[]    = sprintf($this->mSqlQueries['get_set_reference_number'], $kodeKategori, $tanggal, $tanggal, $unitId, $unitId, $kodeKategori,$tanggal, $tanggal);
      ...
      $result        &= $this->Execute($this->mSqlQueries['do_insert_pembukuan_referensi'], array(
         ...
         $bentukTransaksi,
         $bentukTransaksi,
         $param['kategori_jurnal']
      ));

      $queryLog[]    = sprintf($this->mSqlQueries['do_insert_pembukuan_referensi'], $transaksiId, $userId, $tanggal, $param['keterangan'], $statusApproved, $statusKas, $statusKas, $statusKas, $bentukTransaksi, $bentukTransaksi, $bentukTransaksi,$param['kategori_jurnal']);
   ...
   public function doUpdateData($param = array())
   {
      ...
      $queryLog[]       = sprintf($this->mSqlQueries['do_delete_pembukuan_detail'], $pembukuanId);
      $queryLog[]       = sprintf($this->mSqlQueries['do_update_pembukuan_referensi'], $transaksiId, $userId, $tanggal, $param['keterangan'], $statusKas, $statusKas, $statusKas, $bentukTransaksi, $bentukTransaksi, $bentukTransaksi, $param['kategori_jurnal'], $pembukuanId);
