...
class ProcessJurnal
{
   ...
   private function setData()
   {
      ...
      if($this->mObj->method == 'post'){
         ...
         $requestData['kategori_jurnal'] = trim($this->mObj->_POST['kategori_jurnal']);
         $requestData['atribut'] = trim($this->mObj->_POST['atribut']);
   ...
   private function checkData()
   {
      ...
      if($requestData['tanggal'] < $tahunPembukuan['awal'] || $requestData['tanggal'] > $tahunPembukuan['akhir']){
			$err[] = "Tanggal transaksi tidak boleh di luar rentang tanggal tahun pembukuan yang aktif. Rentang tanggal pembukuan aktif <b>".$this->mObj->indonesianDate($tahunPembukuan['awal']).' - '.$this->mObj->indonesianDate($tahunPembukuan['akhir']).'</b>';
		}

      if($requestData['kategori_jurnal'] == ''){
         $err[]      = 'Pilih Kategori Jurnal';
      }
      if($requestData['atribut'] == ''){
         $err[]      = 'Pilih Atribut Jurnal';
      }
