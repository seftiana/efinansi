...
require_once GTFWConfiguration::GetValue( 'application', 'docroot') . 
	'module/unitkerja/business/AppUnitkerja.class.php';
...
class ViewUnitkerja extends HtmlResponse {
	...
	function ParseTemplate($data = NULL) {
		...
		$this->mrTemplate->AddVar('content', 'URL_SEARCH', 
					Dispatcher::Instance()->GetUrl('unitkerja', 'unitkerja', 'view', 'html'));
		$this->mrTemplate->AddVar('content', 'URL_EXCEL', 
					Dispatcher::Instance()->GetUrl('unitkerja', 'unitkerja', 'view', 'xls').
							$data['url_params']);
		$this->mrTemplate->AddVar('content', 'URL_ADD_UNIT', 
					Dispatcher::Instance()->GetUrl('unitkerja', 'inputUnitkerja', 'view', 'html') . 
							'&jenis=unit');
