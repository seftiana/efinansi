...
require_once GTFWConfiguration::GetValue('application','docroot').'module/finansi_transaksi_penerimaan_bank_mhs/business/TransaksiPenerimaanBankMhs.class.php';
...
class ProcessTransaksiPenerimaanBank
{
   ...
   {
      $this->mObj       = new TransaksiPenerimaanBankMhs();
   ...
   private function setData()
   {
      ...
      if($this->mObj->method == 'post'){
         ...
         // jika dari lppa maka rpen_id berisi id dari lppa
         $requestData['ref_kelompok']     = trim($this->mObj->_POST['ref_kelompok']);
