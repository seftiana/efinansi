...
class SppuBp extends Database
{
   ...
   {
      $this->mSqlFile   = 'module/finansi_hapus_bp/business/sppu_bp.sql.php';
   ...
   public function doDeleteBp($id)
   {
      ...
      $result     &= $this->Execute($this->mSqlQueries['update_no_bp_sppu'], array($userId, $id));
