...
/**
* ================= doc ====================
* FILENAME     : ViewEditSubAccountPertama.html.class.php
* @package     : ViewEditSubAccountPertama
* scope        : PUBLIC
* @Author      : Eko Susilo
* @Created     : 2015-02-18
* @Modified    : 2015-02-18
...
class ViewEditSubAccountPertama extends HtmlResponse
{
   function TemplateModule(){
      $this->SetTemplateBasedir(GTFWConfiguration::GetValue('application','docroot').
      'module/sub_account_pertama/template/');
      $this->SetTemplateFile('view_edit_sub_account_pertama.html');
   }
