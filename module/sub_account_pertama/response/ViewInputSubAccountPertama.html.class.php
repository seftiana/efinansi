<?php
/**
 * class ViewInputSubAccountPertama
...
/**
 * class ViewInputSubAccountPertama
 * untuk menangani tampilan input sub account pertama
 * @access public
 */
class ViewInputSubAccountPertama extends HtmlResponse
{
   public function TemplateModule()
   {
      $this->SetTemplateBasedir(GTFWConfiguration::GetValue('application', 'docroot').
         'module/sub_account_pertama/template');
      $this->SetTemplateFile('input_sub_account_pertama.html');
   }
