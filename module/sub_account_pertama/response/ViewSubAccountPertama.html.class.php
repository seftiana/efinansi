...
/**
 * class ViewSubAccountPertama
 * untuk menangani tampilan sub account pertama
 * @access public
 */
class ViewSubAccountPertama extends HtmlResponse
{
   public function TemplateModule()
   {
      $this->SetTemplateBasedir(GTFWConfiguration::GetValue('application','docroot').
         'module/sub_account_pertama/template');
      $this->SetTemplateFile('view_sub_account_pertama.html');
   }
   ...
   public function ParseTemplate($data = NULL)
   {
      ...
      $label      = "Kode Sub Account Pertama";
      $urlDelete  = Dispatcher::Instance()->GetUrl(
         'sub_account_pertama',
         'deleteSubAccountPertama',
         'do',
         'html'
      ).'&'.$queryString;
      ...
      if(empty($dataList)){
         ...
         foreach ($dataList as $list) {
            ...
            if(strtoupper($list['nama']) === 'DEFAULT' || strtoupper($list['kode']) === '00') {
