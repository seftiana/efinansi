    ...
    function ParseTemplate($data = NULL) {
        ...
        if (empty($data['coa'])) {
            ...
            foreach ($data['coa'] as $dt => $item) {
                ...
                $this->mrTemplate->AddVar('list_coa', 'STATUS_AKTIF', $item['statusAktif']);
                ...
                if($item['statusAktif'] != 'Ya'){
                    $this->mrTemplate->AddVar('list_coa', 'HIDE_BTN_EDIT', 'display:none;');
                }else{
                    $this->mrTemplate->AddVar('list_coa', 'HIDE_BTN_EDIT', '');
                }
