   ...
   public function ProcessRequest()
   {
      ...
      if (empty($data)) {
        ...
        // ---------
         ...
         $status_aktif_label     = GTFWConfiguration::GetValue('language','status_aktif');
         /**
          * end set label
          */
         ...
         $sheet->setCellValue('E6', $status_aktif_label);

         $sheet->getStyle('A6:E6')->applyFromArray($styledTableHeaderArray);      
      /**
      ...
      foreach ($dataGrid as $value)
      {
            ...
            $sheet->setCellValue('E'.$row, $value['statusAktif']);
            $nomor++;
            $row++;
      }
      // ---------
