...
class ViewInputCoa extends HtmlResponse {
    ...
    function PrepareData() {
        ...
        if ($_GET['coaid'] != '') {
            ...
            $dataUnitKerja = $ObjCoa->GetCoaUnitKerjaByCoaId($coaId);
    ...
    function ParseTemplate($data = NULL) {
        ...
        //set aksi input
        $this->mrTemplate->AddVar('content', 'URL_ACTION', Dispatcher::Instance()->GetUrl('coa', 'InputCoa', 'do', 'html').'&unit_kerja='.$_GET['unit_kerja']);
        ...
        $this->mrTemplate->AddVar('content', 'UNIT_DATA', json_encode($this->Data[14]));
