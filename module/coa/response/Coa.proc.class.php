...
class ProsessCoa {
    ...
    protected function SetCoaKelompokId($kodeCoa){
        $kodeCoa = substr($kodeCoa,0,1);
        return ($kodeCoa > '5') ? '5' : $kodeCoa;
    }
    ...
    function AddCoa() {
        ...
        $kelompokId = $this->SetCoaKelompokId(str_replace("'", "", $this->POST['kode_akun']));
        ...
        if (($vLr == $vLrAt) && ($vLr == 1) && ($vLrAt == 1)) {
            ...
            if (($this->POST['kode_akun'] != '') && ($this->POST['nama_akun'] != '')) {
                return $this->ObjCoa->InsertCoa($params, $this->POST['tipe_coa_id'], $this->POST['unit']);
            } else {
    ...
    function UpdateCoa() {
        ...
        if (($vLr == $vLrAt) && ($vLr == 1) && ($vLrAt == 1)) {
            ...
            if (($this->POST['kode_akun'] != '') && ($this->POST['nama_akun'] != '')) {
                return $this->ObjCoa->UpdateCoa($params, $this->POST['tipe_coa_id'], $this->POST['unit']);
            } else {
                return 'coa_kode_akun';
            }
        }
    ...
    function InputCoa() {
        ...
        return $urlRedirect.'&unit_kerja='.$this->GET['unit_kerja'];
    }
