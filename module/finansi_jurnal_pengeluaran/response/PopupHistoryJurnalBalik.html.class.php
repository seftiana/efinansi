...
'module/finansi_jurnal_pengeluaran/business/HistoryJurnalBalik.class.php';

class PopupHistoryJurnalBalik extends HtmlResponse
{
   function TemplateModule() {
      $this->SetTemplateBasedir(GTFWConfiguration::GetValue('application','docroot').'module/finansi_jurnal_pengeluaran/template');
