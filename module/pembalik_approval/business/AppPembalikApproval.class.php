...
class AppPembalikApproval extends Database
{
   protected $mSqlFile;
   public $_POST;
   public $_GET;
   ...
   function __construct($connectionNumber=0) {
      $this->mSqlFile      = 'module/pembalik_approval/business/apppembalikapproval.sql.php';
   ...
   function GetDataPembalikApproval($offset, $limit, $param = array())
   {
      ...
      $return     = $this->Open($this->mSqlQueries['get_data_pembalik_approval'], array(
         $param['ta_id'],
         $param['unit_id'],
         $param['unit_id'],
         $param['unit_id'],
   ...
   function GetCountDataPembalikApproval($param = array())
   {
      if(empty($param['bulan']) || ($param['bulan']=='all')) {
           $flag = 1;
       } else {
      ...
      $return  = $this->Open($this->mSqlQueries['get_count_data_pembalik_approval'], array(
         $param['ta_id'],
         $param['unit_id'],
         $param['unit_id'],
         $param['unit_id'],
...
//===DO==
   function DoAddPembalikApproval($dataId)
    {
...
/*
   function GetDataPembalikApprovalById($approvalId) {
      $result = $this->Open($this->mSqlQueries['get_data_approval_by_id'], array($approvalId));
      return $result;
   }

   function GetDataPembalikApprovalByArrayId($arrPembalikApprovalId) {
      $approvalId = implode("', '", $arrPembalikApprovalId);
