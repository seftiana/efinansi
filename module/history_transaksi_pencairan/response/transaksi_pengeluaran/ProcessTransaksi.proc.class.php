      ...
      $cek = true;
        ...
        // }
         ...
         Messenger::Instance()->Send(
									 ...
									 'view',
									 'html',
									 array($this->_POST,'Transaksi Dengan Nomor <b>'.
									 ($this->_POST['no_kkb']).'</b> Sudah Dibuat', $this->cssFail),
									 Messenger::NextRequest);
         ...
         Messenger::Instance()->Send(
									   ...
									   'view',
									   'html',
									   array($this->_POST,'Gagal Merubah Data Transaksi',
