	...
	function Update() {
      ...
      $cek = true;
         ...
         //}else{
            ...
            if($upd_transaksi == true) {
               ...
               */
               ...
               Messenger::Instance()->Send('history_transaksi_pencairan', 'HTPenerimaanDetil', 'view', 'html', array($this->_POST, 'Perubahan Data Transaksi Berhasil Dilakukan', $this->cssDone),Messenger::NextRequest);
        ...
        // }
         ...
         //echo "666";
         //echo "exist";
         Messenger::Instance()->Send('history_transaksi_pencairan', 'HTFormPenerimaan', 'view', 'html', array($this->_POST,'Transaksi Dengan Nomor <b>'.($this->_POST['no_kkb']).'</b> Sudah Dibuat', $this->cssFail),Messenger::NextRequest);
		   return $this->pageView . '&dataId=' . $this->encId;
      } else {
         //gagal masukin data
         //echo "gagal";
         Messenger::Instance()->Send('history_transaksi_pencairan', 'HTFormPenerimaan', 'view', 'html', array($this->_POST,'Gagal Merubah Data Transaksi', $this->cssFail),Messenger::NextRequest);
		   return $this->pageView . '&dataId=' . $this->encId;
      }
      //echo "adflj";
	...
	function Delete() {
      ...
      $deleteArrData = $this->Obj->DoDeleteDataById($arrId);
		if($deleteArrData === true) {
			Messenger::Instance()->Send('history_transaksi_pencairan', 'HTPenerimaan', 'view', 'html', array($this->_POST,'Penghapusan Data Berhasil Dilakukan', $this->cssDone),Messenger::NextRequest);
		} else {
			...
			Messenger::Instance()->Send('history_transaksi_pencairan', 'HTPenerimaan', 'view', 'html', array($this->_POST, $gagal . ' Data Tidak Dapat Dihapus.', $this->cssFail),Messenger::NextRequest);
		}
