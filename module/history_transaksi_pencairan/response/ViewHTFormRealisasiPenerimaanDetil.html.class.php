...
class ViewHTFormRealisasiPenerimaanDetil extends HtmlResponse {
	...
	function TemplateModule() {
		...
		$this->SetTemplateFile('transaksi_realisasi_penerimaan/view_transaksi_detil.html');
            ...
            //////print_r($data['datadbMAK']);
		      ...
		      //$this->mrTemplate->AddVar('content', "MAK_LAMA_ID", $data['datadbMAK']['id']);
				$this->mrTemplate->AddVar('content', "NOMINAL_DISETUJUI",
							number_format($data['datadbMAK']['nominal_disetujui'],2,',','.')
						);
				$this->mrTemplate->AddVar('content', "SISA",
										number_format($data['datadbMAK']['sisa'],2,',','.'));
         } else {
