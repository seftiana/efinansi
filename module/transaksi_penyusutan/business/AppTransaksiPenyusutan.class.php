...
class AppTransaksiPenyusutan extends Database {

	protected $mSqlFile= 'module/transaksi_penyusutan/business/apptransaksipenyusutan.sql.php';
   ...
   public function GetSqlNomorPenyusutan(){
#      $this->SetDebugOn();
      $result = $this->Open($this->mSqlQueries['get_sql_nomor_jurnal_penyusutan'], array());

      $result = $this->Open($result[0]['formulaFormula'], array());
   ...
   function GetUserUnitKerja() {
      ...
      $result = $this->Open($this->mSqlQueries['get_user_unit_kerja'], array($userId));
   ...
   function DoAddTransaksi($arrData) {
      ...
      $query = sprintf($this->mSqlQueries['do_add_transaksi'],
            '3',
            '6',
            $arrData['transUnitkerjaId'],
            $arrData['transReferensi'],
      ...
      $this->DoAddLog("Tambah Transaksi Penyusutan", $query);
      return $insertId;
   }

   function DoAddTransaksiDetilPenyusutan($transId, $invId, $kib, $brgNama, $tglPenyusutan, $periodePenyusutan, $nominal) {
      $this->Connect();
      $result = $this->Execute($this->mSqlQueries['do_add_transaksi_detil_penyusutan'], array($transId, $invId, $kib, $brgNama, $tglPenyusutan, $periodePenyusutan, $nominal));
      /*
   ...
   function DoAddTransaksiDetilPenyusutanGedung($transId, $gdId, $kib, $brgNama, $tglPenyusutan, $periodePenyusutan, $nominal) {
      $this->Connect();
      $result = $this->Execute($this->mSqlQueries['do_add_transaksi_detil_penyusutan_gedung'],array($transId, $gdId, $kib, $brgNama, $tglPenyusutan, $periodePenyusutan, $nominal));
      return $result;
   }
...
//MULAI EDIT DATA
   ...
   function DoUpdateTransaksi($arrData) {
      ...
      $query = sprintf($this->mSqlQueries['do_update_transaksi'],
            ...
            $arrData['transId']);
      //echo $query;
      $this->DoAddLog("Update Transaksi Penyusutan", $query);
      return $result;
   }
