...
require_once GTFWConfiguration::GetValue('application','docroot').
'module/lppa_approval/business/AppReferensi.class.php';
...
class ViewDetailLppa extends HtmlResponse
{
   ...
   function ProcessRequest()
   {
        ...
        $unit_parent = $userUnitKerja->GetUnitKerja($unit['unit_kerja_parent_id']);
            ...
            $this->Data['lppa_file'] = $dataLPPA['lppa_file'];
   ...
   function ParseTemplate($data = null)
   {
      ...
      $urlAction           = Dispatcher::Instance()->GetUrl(
        ...
        $lppaFile            = $documentLppaPath.'/'.$this->Data['lppa_file'];
        $documentDownload    = str_replace($serverRoot, $baseAddress, $lppaFile);

        $this->mrTemplate->AddVar('content', 'DATA_FILE', $this->Data['lppa_file']);
        ...
        $this->mrTemplate->AddVar('content', 'NOMOR_LPPA', $this->Data['nomor_lppa']);
