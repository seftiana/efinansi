...
class ViewEditJurnal extends HtmlResponse 
{
	...
	public function TemplateModule() 
	{
		...
		$this->SetTemplateFile('view_edit_jurnal.html');		
   } 
	...
	{	
		...
		if(empty($this->mData)){
			...
			$return['dataTransaksi']['COA'] = $this->mDBObj->GetTransksiJurnalById($id);
			$return['dataTransaksi']['coa_total_nominal_show'] = 1;
		} else {
	...
	public function ParseTemplate($data = NULL) 
	{
		...
		$this->mrTemplate->AddVar('content', 'URL_ACTION',$url_action_edit);
