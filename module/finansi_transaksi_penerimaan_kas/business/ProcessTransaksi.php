...
class ProcessTransaksi
{
   ...
   {
      $this->mObj       = new TransaksiPenerimaanKas($connectionNumber);
   ...
   private function setData()
   {
      ...
      if(strtoupper($this->mObj->method) == 'POST'){
         ...
         $request_data['sppu_id']            = $this->mObj->_POST['sppu_id'];
         $request_data['sppu_id_old']        = $this->mObj->_POST['sppu_id_old'];
         ...
         // $request_data['keterangan']         = $this->mObj->_POST['keterangan'];
   ...
   private function checkData()
   {
      ...
      if($request_data['nominal'] <= 0){
         $err[]         = 'Nominal transaksi masih kosong';
      }
   ...
   public function Save()
   {
      ...
      if($check['result'] === false){
         ...
         if($process['result'] === true){
            $url        = $this->url_detail.'&transaksi_id='.Dispatcher::Instance()->Encrypt($process['transaksi_kas_id']);
