...
require_once GTFWConfiguration::GetValue( 'application', 'docroot').
   'module/jurnal_pengeluaran/business/AppPopupCoaKredit.class.php';
...
class ViewPopupCoaKredit extends HtmlResponse
{
   ...
   function TemplateModule()
   {
      ...
      $this->SetTemplateFile('popup_coa_kredit.html');
   }
   ...
   function ProcessRequest()
   {
      ...
      $return['url']['search'] = Dispatcher::Instance()->GetUrl('jurnal_pengeluaran','popupCoaKredit','view','html');
      // ---------
   ...
   {
      #print_r($data);
       $this->mrTemplate->AddVar('content', 'URL_SEARCH', Dispatcher::Instance()->GetUrl('jurnal_pengeluaran', 'popupCoaKredit', 'view', 'html'));
