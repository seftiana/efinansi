...
class ViewExcelLapAktivitasDetil extends XlsxResponse {
    ...
    function ProcessRequest() {
        ...
        $this->SetFileName('laporan_penghasilan_komprehensif_detail_' . date("d-m-Y") . '.xls');
            ...
            foreach ($dataAktivitas as $itemLaporan) {
                ...
                if ($itemLaporan['is_summary'] == 'Y') {
                    ...
                    if ($itemLaporan['is_child'] == '0') {
                        ...
                        $dataDetail = $this->mObj->LaporanBuilder()->getLaporanDetail($tglAwal, $tglAkhir, $itemLaporan['id'],$subAccount,$status);
                    }
                }
