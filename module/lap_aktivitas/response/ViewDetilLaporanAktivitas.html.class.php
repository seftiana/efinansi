...
class ViewDetilLaporanAktivitas extends HtmlResponse {
    ...
    function ProcessRequest() {
        ...
        $id_kel_lap = Dispatcher::Instance()->Decrypt($_GET['kellap_id']);
        $status = Dispatcher::Instance()->Decrypt($_GET['status']);
        $tanggalAwal = Dispatcher::Instance()->Decrypt($_GET['tanggal_awal']);
        $tanggalAkhir = Dispatcher::Instance()->Decrypt($_GET['tanggal_akhir']);
