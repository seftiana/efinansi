<?php
/**
 * class ViewInputSubAccountKeenam
...
/**
 * class ViewInputSubAccountKeenam
 * untuk menangani tampilan input sub account keenam
 * @access public
 */
class ViewInputSubAccountKeenam extends HtmlResponse
{
   public function TemplateModule()
   {
      $this->SetTemplateBasedir(GTFWConfiguration::GetValue('application', 'docroot').
         'module/sub_account_keenam/template');
      $this->SetTemplateFile('input_sub_account_keenam.html');
   }
