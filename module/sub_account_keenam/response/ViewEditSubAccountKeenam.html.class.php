...
/**
* ================= doc ====================
* FILENAME     : ViewEditSubAccountKeenam.html.class.php
* @package     : ViewEditSubAccountKeenam
* scope        : PUBLIC
* @Author      : Eko Susilo
* @Created     : 2015-02-18
* @Modified    : 2015-02-18
...
class ViewEditSubAccountKeenam extends HtmlResponse
{
   function TemplateModule(){
      $this->SetTemplateBasedir(GTFWConfiguration::GetValue('application','docroot').
      'module/sub_account_keenam/template/');
      $this->SetTemplateFile('view_edit_sub_account_keenam.html');
   }
