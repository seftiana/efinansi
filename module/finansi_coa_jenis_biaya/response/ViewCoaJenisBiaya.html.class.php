...
class ViewCoaJenisBiaya extends HtmlResponse {
    ...
    function ParseTemplate($data = NULL) {
        ...
        if (empty($listCoaJenisBiaya)) {
            ...
            for ($i = 0; $i < sizeof($listCoaJenisBiaya); $i++) {
                ...
                $urlReturn  = 'finansi_coa_jenis_biaya|CoaJenisBiaya|view|html';
                ...
                $listCoaJenisBiaya[$i]['jb_url_edit'] = Dispatcher::Instance()->GetUrl(
                    'finansi_coa_jenis_biaya', 'CoaJenisBiaya', 'view', 'html') . '&dataId=' . $listCoaJenisBiaya[$i]['id'];
