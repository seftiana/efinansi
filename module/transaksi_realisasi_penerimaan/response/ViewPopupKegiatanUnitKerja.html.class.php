<?php
require_once GTFWConfiguration::GetValue( 'application', 'docroot') . 'module/transaksi_realisasi_penerimaan/business/AppPopupKegiatanUnitKerja.class.php';
...
class ViewPopupKegiatanUnitKerja extends HtmlResponse {
	...
	function ParseTemplate($data = NULL) {
		...
		$this->mrTemplate->AddVar('content', 'URL_SEARCH', Dispatcher::Instance()->GetUrl('transaksi_realisasi_penerimaan', 'popupKegiatanDetil', 'view', 'html'));
		if($this->Pesan) {
