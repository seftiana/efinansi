...
class AppTransaksi extends Database {
	...
	protected $mSqlFile= 'module/transaksi_realisasi_penerimaan/business/apptransaksi.sql.php';
   ...
   function DoAddPembukuanDetil($idPembukuan, $nilai, $arrSkenarioId=array()) {
      ...
      //for($i = 0 ; $i < count($arrSkenarioId);$i++){
      //	$result_debet = $this->Execute($this->mSqlQueries['do_add_pembukuan_detil_debet'],
      //	 						array($idPembukuan, $nilai, $arrSkenarioId[$i]));
      //}
