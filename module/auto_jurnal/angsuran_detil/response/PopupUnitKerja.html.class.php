<?php
require_once GTFWConfiguration::GetValue( 'application', 'docroot') . 'module/angsuran_detil/business/AppPopupUnitKerja.class.php';
...
class PopupUnitKerja extends HtmlResponse {
	...
	function ParseTemplate($data = NULL) {
		...
		$this->mrTemplate->AddVar('content', 'URL_SEARCH', Dispatcher::Instance()->GetUrl('angsuran_detil', 'unitKerja', 'popup', 'html'));
		if($this->Pesan) {
