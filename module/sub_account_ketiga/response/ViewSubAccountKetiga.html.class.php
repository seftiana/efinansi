...
/**
 * class ViewSubAccountKetiga
 * untuk menangani tampilan sub account ketiga
 * @access public
 */
class ViewSubAccountKetiga extends HtmlResponse
{
   public function TemplateModule()
   {
      $this->SetTemplateBasedir(GTFWConfiguration::GetValue('application','docroot').
         'module/sub_account_ketiga/template');
      $this->SetTemplateFile('view_sub_account_ketiga.html');
   }
   ...
   public function ParseTemplate($data = NULL)
   {
      ...
      $label      = "Kode Sub Account Ketiga";
      $urlDelete  = Dispatcher::Instance()->GetUrl(
         'sub_account_ketiga',
         'deleteSubAccountKetiga',
         'do',
         'html'
      ).'&'.$queryString;
