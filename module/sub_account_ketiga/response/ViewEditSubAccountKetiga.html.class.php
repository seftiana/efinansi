...
/**
* ================= doc ====================
* FILENAME     : ViewEditSubAccountKetiga.html.class.php
* @package     : ViewEditSubAccountKetiga
* scope        : PUBLIC
* @Author      : Eko Susilo
* @Created     : 2015-02-18
* @Modified    : 2015-02-18
...
class ViewEditSubAccountKetiga extends HtmlResponse
{
   function TemplateModule(){
      $this->SetTemplateBasedir(GTFWConfiguration::GetValue('application','docroot').
      'module/sub_account_ketiga/template/');
      $this->SetTemplateFile('view_edit_sub_account_ketiga.html');
   }
