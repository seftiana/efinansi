<?php
/**
 * class ViewInputSubAccountKetiga
...
/**
 * class ViewInputSubAccountKetiga
 * untuk menangani tampilan input sub account ketiga
 * @access public
 */
class ViewInputSubAccountKetiga extends HtmlResponse
{
   public function TemplateModule()
   {
      $this->SetTemplateBasedir(GTFWConfiguration::GetValue('application', 'docroot').
         'module/sub_account_ketiga/template');
      $this->SetTemplateFile('input_sub_account_ketiga.html');
   }
