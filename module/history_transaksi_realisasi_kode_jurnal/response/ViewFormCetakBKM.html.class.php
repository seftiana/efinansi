<?php
require_once GTFWConfiguration::GetValue( 'application', 'docroot') . 'module/history_transaksi_realisasi_kode_jurnal/business/AppTransaksi.class.php';
...
class ViewFormCetakBKM extends HtmlResponse {
	...
	function TemplateModule() {
		$this->SetTemplateBasedir(GTFWConfiguration::GetValue('application','docroot') . 'module/history_transaksi_realisasi_kode_jurnal/template');
	...
	function ProcessRequest() {
		...
		//$arr_pejabat_biro_keuangan = $Obj->GetJabatanNama('');
		...
		Messenger::Instance()->SendToComponent(
												...
												array(
													...
													'', 
													'false', 
													' id="pejabat_diserahkan" style="width:200px;" '), 
												Messenger::CurrentRequest);
	...
	function ParseTemplate($data = NULL) {
		...
		$this->mrTemplate->AddVar('content', 'URL_ACTION', Dispatcher::Instance()->GetUrl('history_transaksi_realisasi_kode_jurnal', 'CetakBuktiTransaksi', 'view', 'html') . "&dataId=" . Dispatcher::Instance()->Encrypt($data['decDataId']) . '&tipe=bkm');
		$this->mrTemplate->AddVar('content', 'URL_CETAK', Dispatcher::Instance()->GetUrl('history_transaksi_realisasi_kode_jurnal', 'CetakBuktiTransaksi', 'view', 'html') . "&dataId=" . Dispatcher::Instance()->Encrypt($data['decDataId']) . '&tipe=bkm');
