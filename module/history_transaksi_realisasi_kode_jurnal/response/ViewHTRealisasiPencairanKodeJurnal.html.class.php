...
require_once GTFWConfiguration::GetValue( 'application', 'docroot') . 
			'module/history_transaksi_realisasi_kode_jurnal/business/HTRealisasiPencairanKodeJurnal.class.php';

class ViewHTRealisasiPencairanKodeJurnal extends HtmlResponse 
{
	...
	public function TemplateModule() 
	{
		...
		$this->SetTemplateFile('view_ht_realisasi_pencairan_kode_jurnal.html');
	}
	
	public function ProcessRequest() 
	{
	  $Obj = new HTRealisasiPencairanKodeJurnal();
	...
	public function ParseTemplate($data = NULL) 
	{
		$this->mrTemplate->AddVar('content', 'URL_SEARCH', 
											Dispatcher::Instance()->GetUrl(
															'history_transaksi_realisasi_kode_jurnal', 
		...
		if (empty($data['dataDetilTransaksi'])) {
			...
			$this->mrTemplate->AddVar('data', 'DATA_EMPTY', 'NO');
         	...
         	$label = GTFWConfiguration::GetValue('language','transaksi_realisasi_kode_jurnal');
         	$urlDelete = 'history_transaksi_realisasi_kode_jurnal|deleteTransaksi|do|html';
         	$urlReturn = 'history_transaksi_realisasi_kode_jurnal|HTRealisasiPencairanKodeJurnal|view|html';
            ...
            if($dataDetilTransaksi[$i]['is_jurnal'] == "Y") {
               ...
               $dataDetilTransaksi[$i]['url_delete'] = '<a class="xhr dest_subcontent-element" '.
													   ...
													   $dataDetilTransaksi[$i]['id'].'", "'.
													   $dataDetilTransaksi[$i]['kkb'].'", "'.$URLDELETE.
													   '");" href="'.$url_deletee.
