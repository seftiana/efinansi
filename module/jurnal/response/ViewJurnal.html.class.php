...
class ViewJurnal extends HtmlResponse
{
   ...
   {
      $arrSubAkun       =  $this->proc->db->getSubAccountCombo();
      ...
      else
      {
         ...
         $this->data = $this->proc->db->GetData($no_referensi,$sub_account,$bulan, $tahun, $startRec, $itemViewed);
         $totalData = $this->proc->db->GetCount($no_referensi,$sub_account,$bulan, $tahun);
      }
      $url = Dispatcher::Instance()->GetUrl(Dispatcher::Instance()->mModule, Dispatcher::Instance()->mSubModule, Dispatcher::Instance()->mAction, Dispatcher::Instance()->mType) .
         ...
         '&sub_account=' . Dispatcher::Instance()->Encrypt($sub_account) .
      ...
      $return['sub_account'] = $sub_account;
      $return['bulan'] = $bulan;
      $return['tahun'] = $tahun;
   ...
   function ParseTemplate($data = NULL)
   {
      ...
      $urlCetak = Dispatcher::Instance()->GetUrl(
        ...
        '&sub_account=' . Dispatcher::Instance()->Encrypt($data['sub_account']) .
      ...
      else
      {
         ...
         for ($i = 0;$i < sizeof($dataGrid);)
         {
            ...
            if($refId == $dataGrid[$i]['id']) {
                ...
                $dataGridx[$ix]['url_cetak'] = '<a href="javascript:cetak(\'' . Dispatcher::Instance()->GetUrl($this->proc->moduleName, 'cetakJurnal', 'view', 'html') . '&id=' . $id . '&prid='.$idEnc.'&sub_account='.$data['sub_account'].'\')" ><img src="images/button-print.gif" alt="Cetak"></a>';
