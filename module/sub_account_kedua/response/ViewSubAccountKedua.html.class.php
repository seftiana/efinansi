...
/**
 * class ViewSubAccountKedua
 * untuk menangani tampilan sub account kedua
 * @access public
 */
class ViewSubAccountKedua extends HtmlResponse
{
   public function TemplateModule()
   {
      $this->SetTemplateBasedir($this->mrConfig->mApplication['docroot'].
         'module/sub_account_kedua/template');
      $this->SetTemplateFile('view_sub_account_kedua.html');
   }
