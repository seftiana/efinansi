...
class ViewExcelLaporanKonsolidasiArusKas extends XlsxResponse
{
   # Internal Variables
   public $Excel;
   protected $mObj;
   ...
   function ProcessRequest()
   {
      ...
      $this->SetFileName('laporan_konsolidasi_arus_kas_' . date("d-m-Y") . '.xls');
      ...
      if (empty($dataInstitute)) {
         ...
         $sheet->setCellValueByColumnAndRow(0, 2, 'Laporan Konsolidasi Arus Kas');
