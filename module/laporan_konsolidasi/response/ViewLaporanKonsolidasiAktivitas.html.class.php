...
class ViewLaporanKonsolidasiAktivitas extends HtmlResponse {
    protected $mObj;

    function TemplateModule() {
        $this->SetTemplateBasedir(GTFWConfiguration::GetValue('application', 'docroot')
            . 'module/laporan_konsolidasi/template');
        $this->SetTemplateFile('view_laporan_konsolidasi_aktivitas.html');
    }
    ...
    function ParseTemplate($data = NULL) {
        ...
        $this->mrTemplate->AddVar('content', 'URL_CETAK',
            Dispatcher::Instance()->GetUrl(
                'laporan_konsolidasi',
                'CetakLaporanKonsolidasiAktivitas',
                'view',
                'html'
            ).
        ...
        $this->mrTemplate->AddVar('content', 'URL_EXCEL',
            Dispatcher::Instance()->GetUrl(
                'laporan_konsolidasi',
                'ExcelLaporanKonsolidasiAktivitas',
                'view',
                'xlsx'
            ).
            '&tanggal_awal='.Dispatcher::Instance()->Encrypt($requestData['tanggal_awal']).
