...
class ViewExcelLaporanKonsolidasi extends XlsxResponse
{
   # Internal Variables
   public $Excel;
   protected $mObj;
   ...
   function ProcessRequest()
   {
      ...
      $this->SetFileName('laporan_konsolidasi_' . date("d-m-Y") . '.xls');
      ...
      if (empty($dataInstitute)) {
         ...
         $row++;  $coll = 0;
         $sheet->setCellValueByColumnAndRow(0, 2, 'Laporan Konsolidasi');
         $row++;
         $coll = 0;
         ...
         $sheet->setCellValue('E6','Konsolidasi');
         $sheet->setCellValue('C7','Institute Perbanas');
