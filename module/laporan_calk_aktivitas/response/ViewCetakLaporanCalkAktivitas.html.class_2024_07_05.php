...
class ViewCetakLaporanCalkAktivitas extends HtmlResponse {
    protected $mObj;
    ...
    public function TemplateModule() {
        ...
        $this->SetTemplateFile('view_cetak_laporan_calk_aktivitas.html');
    }
    ...
    public function ParseTemplate($data = NULL) {
        ...
        foreach ($aktivitas as $itemLaporan) {
                ...
                if ($itemLaporan['is_child'] == '0') {
                    ...
                    if(!empty($dataDetail)){
                        ...
                        foreach($dataDetail as $valueDet){
                            ...
                            if($akumulasi != 0){
                                $valueDet['persentase'] = round((($nominal - $akumulasi)/$akumulasi),2)*100;
                            }else{
                        ...
                        if($totalAkm != 0){
                            $persentase = round((($total - $totalAkm)/$totalAkm),2)*100;
                        }else{
                            $persentase = 0;
                        }
            ...
            if($jumlahSaldoKlpAkm != 0){
                $persentaseParent = round((($jumlahSaldoKlp - $jumlahSaldoKlpAkm)/$jumlahSaldoKlpAkm),2)*100;
            }else{
                $persentaseParent = 0;
            }
