...
class PerhitunganLapRef extends Database {
    ...
    protected $mSqlFile = 'module/finansi_laporan_builder_sementara/business/perhitungan_lap_ref.sql.php';
        ...
        if (!empty($kellapRefDataCoa)) {
            ...
            foreach ($kellapRefDataCoa as $itemValue) {
                if (($itemValue['kellap_is_saldo_awal'] == 'Y') &&
                    ...
                    //tahun pembukuan aktif
                    $hitungSaldo = $this->_mBukuBesar->getSaldoAwaltahun($itemValue['kellap_coa_id']) +
                            $this->_mBukuBesar->getSaldoMutasiDK($itemValue['kellap_coa_id'], 'D');
