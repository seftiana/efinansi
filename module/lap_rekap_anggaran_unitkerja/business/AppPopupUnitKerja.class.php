...
class AppPopupUnitKerja extends Database {
   ...
   {
      $this->mSqlFile   = 'module/lap_rekap_anggaran_unitkerja/business/apppopupunitkerja.sql.php';
   ...
   {
      $return     = $this->Open($this->mSqlQueries['get_data_tipe_unit'], array());
   ...
   public function GetData($offset, $limit, $param = array())
   {
      ...
      $return     = $this->Open($this->mSqlQueries['get_data'], array(
         ...
         '%'.$param['nama'].'%',
         $param['tipe'],
         (int)($param['tipe'] == '' OR $param['tipe'] === NULL OR strtolower($param['tipe']) == 'all'),
         $dataUnit['id'],
         $dataUnit['id'],
         $dataUnit['id'],
         $offset,
