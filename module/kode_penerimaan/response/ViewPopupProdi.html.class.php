...
require_once GTFWConfiguration::GetValue('application', 'docroot').
	'module/kode_penerimaan/business/AppPopupProdi.class.php';

class ViewPopupProdi extends HtmlResponse 
{
	...
	public function TemplateModule()
	{
		...
		$this->SetTemplateFile('view_popup_prodi.html');
	}
	...
	public function ParseTemplate($data = NULL) 
	{
		...
		$this->mrTemplate->AddVar('content', 'URL_SEARCH', 
				Dispatcher::Instance()->GetUrl(Dispatcher::Instance()->mModule, 'popupProdi', 'view', 'html'));
