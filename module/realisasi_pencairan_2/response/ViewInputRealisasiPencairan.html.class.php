...
class ViewInputRealisasiPencairan extends HtmlResponse {
    ...
    function ProcessRequest() {
        ...
        if (isset($grp) AND $grp !== NULL) {
            ...
            $requestData['fpa_file'] = $dataPengajuan['fpa_file'];
        ...
        if ($messenger) {
            ...
            $requestData['fpa_file'] = $messengerData['fpa_file'];
    ...
    function ParseTemplate($data = NULL) {
        ...
        $documentFpaPath     = realpath($documentRoot.'/document/fpa/');
        ...
        switch (strtoupper($requestData['action'])) {
            ...
            case 'EDIT':
                ...
                $fpaFile             = $documentFpaPath.'/'.$requestData['fpa_file'];
                $documentDownload    = str_replace($serverRoot, $baseAddress, $fpaFile);

                $this->mrTemplate->AddVar('content', 'DATA_FILE', $requestData['fpa_file']);
