...
/**
 * 
 * class ViewCetakLapIhktisarBelanjaPerPK
...
class ViewCetakLapIhktisarBelanjaPerPK extends HtmlResponse
{
	...
	public function TemplateModule()
	{
		...
		$this->SetTemplateFile('view_cetak_lap_ihktisar_belanja_per_pk.html');
	}
	...
	public function ProcessRequest()
	{
		...
		$return['get_header']  = $this->mDBObj->GetPaguBasHeader($tahun_anggaran,$unitkerja);
		$return['get_nominal_pengeluaran'] = $this->mDBObj->GetNominalPengeluaran($tahun_anggaran,$unitkerja);		
		$return['get_nominal_pengeluaran_per_k']=$this->mDBObj->GetNominalPengeluaranPerK($tahun_anggaran,$unitkerja);		
		$return['get_nominal_pengeluaran_per_p']=$this->mDBObj->GetNominalPengeluaranPerP($tahun_anggaran,$unitkerja);		
