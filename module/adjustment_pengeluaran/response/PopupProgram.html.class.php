<?php
require_once GTFWConfiguration::GetValue( 'application', 'docroot') . 'module/adjustment_pengeluaran/business/AppPopupProgram.class.php';
...
class PopupProgram extends HtmlResponse {
	...
	function ParseTemplate($data = NULL) {
		...
		$this->mrTemplate->AddVar('content', 'URL_SEARCH', Dispatcher::Instance()->GetUrl('adjustment_pengeluaran', 'program', 'popup', 'html') . '&tahun_anggaran=' . Dispatcher::Instance()->Encrypt($search['tahun_anggaran']) . '&tahun_anggaran_label=' . Dispatcher::Instance()->Encrypt($search['tahun_anggaran_label']));
		if($this->Pesan) {
