...
/**
* ================= doc ====================
* FILENAME     : ViewKomponen.xlsx.class.php
* @package     : ViewKomponen
* scope        : PUBLIC
* @Author      : Eko Susilo
* @Created     : 2015-03-17
* @Modified    : 2015-03-17
...
class ViewKomponen extends XlsxResponse
{
   # Internal Variables
   public $Excel;
   ...
   function ProcessRequest()
   {
      ...
      $this->SetFileName('daftar_komponen.xls');
      ...
      if(empty($dataList)){
         ...
         foreach ($dataList as $list) {
            $height  = max(array(
               ...
               ceil(strlen($list['deskripsi'])/30),
               ceil(strlen($list['mak_nama'])/20)
            ));
            $rowHeight  = $height*14;
            ...
            $sheet->setCellValue('D'.$row, $list['kode_coa']);
            $sheet->setCellValue('E'.$row, $list['nama_coa']);
