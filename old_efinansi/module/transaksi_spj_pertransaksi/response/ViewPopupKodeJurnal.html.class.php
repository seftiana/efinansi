<?php
require_once GTFWConfiguration::GetValue( 'application', 'docroot') . 'module/transaksi_spj/business/KodeJurnal.class.php';
...
class ViewPopupKodeJurnal extends HtmlResponse {
	...
	function ParseTemplate($data = NULL) {
	   ...
	   $this->mrTemplate->AddVar('content', 'URL_SEARCH', Dispatcher::Instance()->GetUrl('transaksi_spj', 'popupKodeJurnal', 'view', 'html'));
...
//mulai bikin tombol delete
			...
			$urlDelete = Dispatcher::Instance()->GetUrl('transaksi_spj', 'deleteKodeJurnal', 'do', 'html');
			$urlReturn = Dispatcher::Instance()->GetUrl('transaksi_spj', 'kodeJurnal', 'view', 'html');
