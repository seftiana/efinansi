...
require_once GTFWConfiguration::GetValue( 'application', 'docroot') . 'module/transaksi_spj_pertransaksi/business/AppPopupCoa.class.php';
...
class ViewPopupCoa extends HtmlResponse {
   ...
   function ProcessRequest() {
     $this->Coa = new AppPopupCoa;		  	
      ...
      $url = Dispatcher::Instance()->GetUrl(Dispatcher::Instance()->mModule, 
               ...
               Dispatcher::Instance()->mType).'&data[nama]='.$this->data['nama'];
   ...
   function ParseTemplate($data = NULL) {      
      ...
      $this->mrTemplate->AddVar('content', 'URL_SEARCH', Dispatcher::Instance()->GetUrl('transaksi_spj_pertransaksi', 'coa', 'popup', 'html').'&data[name]='.$this->data['nama']);      
