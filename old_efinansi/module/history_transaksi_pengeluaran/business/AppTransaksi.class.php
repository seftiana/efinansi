...
class AppTransaksi extends Database {
	...
	protected $mSqlFile= 'module/history_transaksi_pengeluaran/business/apptransaksi.sql.php';
   ...
   function GetComboTipeTransaksi() {
	...
	function GetTipeTransaksi($name) {
		$result = $this->Open($this->mSqlQueries['get_tipe_transaksi'], array($_SESSION['username'],$name));
		return $result;
   }
...
//FORM CETAK
   ...
   function GetJabatan($jab) {
	...
	function GetTahunPembukuan() {
      $result = $this->Open($this->mSqlQueries['get_tahun_pembukuan_periode'], array());
      return $result;
   }
