...
require_once GTFWConfiguration::GetValue( 'application', 'docroot') . 
	'module/history_transaksi_pengeluaran/business/AppPopupKegiatanUnitKerja.class.php';
...
class ViewPopupKegiatanUnitKerja extends HtmlResponse {
	...
	function ParseTemplate($data = NULL) {
		...
		$this->mrTemplate->AddVar('content', 'URL_SEARCH', Dispatcher::Instance()->GetUrl('history_transaksi_pengeluaran', 'popupKegiatanDetil', 'view', 'html'));
		if($this->Pesan) {
