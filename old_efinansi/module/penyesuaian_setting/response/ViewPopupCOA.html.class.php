...
require_once GTFWConfiguration::GetValue('application', 'docroot').
   'module/'.Dispatcher::Instance()->mModule.'/business/KodeJurnal.class.php';
...
class ViewPopupCOA extends HtmlResponse
{
   ...
   function ProcessRequest ()
   {
      ...
      $return['dataGrid'] = $Obj->GetCoaListBySearch($filter, $startRec, $itemViewed);
      ...
      if (!isset($_GET['form'])) $return['form'] = 'frm_input';
      else $return['form'] = (string) $_GET['form'];
      return $return;
   }
