...
require_once GTFWConfiguration::GetValue( 'application', 'docroot') . 
		'module/penerima_alokasi_unit/business/PopupUnitKerjaCari.class.php';
require_once GTFWConfiguration::GetValue( 'application', 'docroot') . 
		'module/user_unit_kerja/business/UserUnitKerja.class.php';

class ViewPopupUnitKerjaCari extends HtmlResponse 
{
	...
	public function TemplateModule() 
	{
		...
		$this->SetTemplateFile('view_popup_unit_kerja_cari.html');
	}
    ...
    {
		$this->unitkerjaObj = new PopupUnitKerjaCari();
