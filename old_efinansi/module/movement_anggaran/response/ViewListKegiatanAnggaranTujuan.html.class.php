    ...
    class ViewListKegiatanAnggaranTujuan extends HtmlResponse{
        ...
        function ProcessRequest(){
            ...
            if(!empty($this->POST)) 
            {
			    ...
			    $kode           = $this->POST['unitKerjaIdTujuan'];
 ...
 # Combobox
      Messenger::Instance()->SendToComponent(
        ...
        function ParseTemplate($data = null){
            ...
            $url_search = Dispatcher::Instance()->GetUrl('movement_anggaran', 'ListKegiatanAnggaranTujuan', 'view', 'html').
        ...
        $this->mrTemplate->AddVar('content', 'UNIT_KERJA_ID_TUJUAN', $data['unit_id']);
        $this->mrTemplate->AddVar('content', 'UNIT_KERJA_NAMA_TUJUAN', $data['unit_nama']);
