...
class ViewCetakLapRencanaPenerimaan extends HtmlResponse 
{
	...
	public function TemplateModule() 
	{
		$this->SetTemplateBasedir(GTFWConfiguration::GetValue('application','docroot').
  		...
  		$this->SetTemplateFile('cetak_lap_rencana_penerimaan.html');
   	}
	...
	public function ProcessRequest() 
	{
		...
		$statusApprove = Dispatcher::Instance()->Decrypt($_GET['status_approve']);
