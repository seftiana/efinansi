...
class ViewPopupKodeJurnal extends HtmlResponse {
	...
	function ParseTemplate($data = NULL) {
	   ...
	   $this->mrTemplate->AddVar('content', 'URL_SEARCH', Dispatcher::Instance()->GetUrl('transaksi_kode_jurnal', 'popupKodeJurnal', 'view', 'html'));
...
//mulai bikin tombol delete
			...
			$urlDelete = Dispatcher::Instance()->GetUrl('transaksi_kode_jurnal', 'deleteKodeJurnal', 'do', 'html');
			$urlReturn = Dispatcher::Instance()->GetUrl('transaksi_kode_jurnal', 'kodeJurnal', 'view', 'html');
