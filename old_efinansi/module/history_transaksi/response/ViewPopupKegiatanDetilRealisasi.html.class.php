...
'module/history_transaksi/business/transaksi_realisasi/AppPopupKegiatanDetil.class.php';
...
class ViewPopupKegiatanDetilRealisasi extends HtmlResponse {
	...
	function ParseTemplate($data = NULL) {
		...
		$this->mrTemplate->AddVar('content', 'URL_SEARCH', Dispatcher::Instance()->GetUrl('history_transaksi', 'popupKegiatanDetilRealisasi', 'view', 'html') . '&unitkerja=' . $this->encUnitkerjaId);
		if($this->Pesan) {
