...
'module/finansi_transaksi_penerimaan_bank/business/AppReferensi.class.php';
   ...
   function ParseTemplate($data = null){
      ...
      if(empty($dataList)){
         ...
         foreach ($dataList as $list) {
            ...
            $this->mrTemplate->AddVar('content_links', 'KODE', $list['kode']);
            $this->mrTemplate->AddVar('content_links', 'NAMA', $list['nama']);
