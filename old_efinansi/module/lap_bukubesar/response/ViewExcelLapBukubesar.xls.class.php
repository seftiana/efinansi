...
class ViewExcelLapBukubesar extends XlsResponse {
   ...
   function ProcessRequest() {
      ...
      if (empty($data)) {
         ...
         #set header
         $this->mWorksheets['Data']->write(0, 0, 'Laporan Buku Besar', $fTitle);
         ...
         for ($i=0;$i<sizeof($data);$i++) {
            $this->mWorksheets['Data']->write($num, 0, IndonesianDate($data[$i]['tanggal_jurnal_entri'],'yyyy-mm-dd'), $fColNomor);
