...
require_once GTFWConfiguration::GetValue( 'application', 'docroot') . 
	'module/history_transaksi_realisasi_kode_jurnal/business/AppTransaksi.class.php';
...
class ViewFormCetakTransaksi extends HtmlResponse {
	...
	function TemplateModule() {
		...
		'module/history_transaksi_realisasi_kode_jurnal/template');
	...
	function ParseTemplate($data = NULL) {
		...
		$this->mrTemplate->AddVar('content', 'URL_ACTION', Dispatcher::Instance()->GetUrl('history_transaksi_realisasi_kode_jurnal', 'cetakTransaksi', 'view', 'html') . "&dataId=" . Dispatcher::Instance()->Encrypt($data['decDataId']));
		$this->mrTemplate->AddVar('content', 'URL_CETAK', Dispatcher::Instance()->GetUrl('history_transaksi_realisasi_kode_jurnal', 'cetakTransaksi', 'view', 'html') . "&dataId=" . Dispatcher::Instance()->Encrypt($data['decDataId']));

		$this->mrTemplate->AddVar('content', 'URL_BATAL', Dispatcher::Instance()->GetUrl('history_transaksi_realisasi_kode_jurnal', 'HTRealisasiPencairanKodeJurnal', 'view', 'html'));
