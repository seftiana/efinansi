<?php
require_once GTFWConfiguration::GetValue( 'application', 'docroot') . 'module/approval_pencairan/business/AppPopupProgram.class.php';
...
class ViewPopupProgram extends HtmlResponse {
	...
	function ParseTemplate($data = NULL) {
		...
		$this->mrTemplate->AddVar('content', 'URL_SEARCH', Dispatcher::Instance()->GetUrl('approval_pencairan', 'popupProgram', 'view', 'html') . '&tahun_anggaran=' . Dispatcher::Instance()->Encrypt($search['tahun_anggaran']) . '&tahun_anggaran_label=' . Dispatcher::Instance()->Encrypt($search['tahun_anggaran_label']));
		if($this->Pesan) {
