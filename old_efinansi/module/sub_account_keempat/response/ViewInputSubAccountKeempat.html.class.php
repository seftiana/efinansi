<?php
/**
 * class ViewInputSubAccountKeempat
...
/**
 * class ViewInputSubAccountKeempat
 * untuk menangani tampilan input sub account keempat
 * @access public
 */
class ViewInputSubAccountKeempat extends HtmlResponse
{
   public function TemplateModule()
   {
      $this->SetTemplateBasedir(GTFWConfiguration::GetValue('application', 'docroot').
         'module/sub_account_keempat/template');
      $this->SetTemplateFile('input_sub_account_keempat.html');
   }
