...
/**
 * class ViewSubAccountKeenam
 * untuk menangani tampilan sub account keenam
 * @access public
 */
class ViewSubAccountKeenam extends HtmlResponse
{
   public function TemplateModule()
   {
      $this->SetTemplateBasedir(GTFWConfiguration::GetValue('application','docroot').
         'module/sub_account_keenam/template');
      $this->SetTemplateFile('view_sub_account_keenam.html');
   }
   ...
   public function ParseTemplate($data = NULL)
   {
      ...
      $label      = "Kode Sub Account Keenam";
      $urlDelete  = Dispatcher::Instance()->GetUrl(
         'sub_account_keenam',
         'deleteSubAccountKeenam',
         'do',
         'html'
      ).'&'.$queryString;
