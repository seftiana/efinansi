...
/**
* ================= doc ====================
* FILENAME     : AppRencanaPenerimaan.class.php
* @package     : AppRencanaPenerimaan
* scope        : PUBLIC
* @Author      : Eko Susilo
* @Created     : 2015-03-05
* @Modified    : 2015-03-05
...
class AppRencanaPenerimaan extends Database
{
   ...
   {
      $this->mSqlFile   = 'module/finansi_transaksi_realisasi_penerimaan/business/app_rencana_penerimaan.sql.php';
