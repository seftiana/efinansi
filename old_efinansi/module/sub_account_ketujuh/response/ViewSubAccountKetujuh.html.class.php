...
/**
 * class ViewSubAccountKetujuh
 * untuk menangani tampilan sub account ketujuh
 * @access public
 */
class ViewSubAccountKetujuh extends HtmlResponse
{
   public function TemplateModule()
   {
      $this->SetTemplateBasedir(GTFWConfiguration::GetValue('application','docroot').
         'module/sub_account_ketujuh/template');
      $this->SetTemplateFile('view_sub_account_ketujuh.html');
   }
   ...
   public function ParseTemplate($data = NULL)
   {
      ...
      $label      = "Kode Sub Account Ketujuh";
      $urlDelete  = Dispatcher::Instance()->GetUrl(
         'sub_account_ketujuh',
         'deleteSubAccountKetujuh',
         'do',
         'html'
      ).'&'.$queryString;
