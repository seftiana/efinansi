...
/**
* ================= doc ====================
* FILENAME     : ViewEditSubAccountKetujuh.html.class.php
* @package     : ViewEditSubAccountKetujuh
* scope        : PUBLIC
* @Author      : Eko Susilo
* @Created     : 2015-02-18
* @Modified    : 2015-02-18
...
class ViewEditSubAccountKetujuh extends HtmlResponse
{
   function TemplateModule(){
      $this->SetTemplateBasedir(GTFWConfiguration::GetValue('application','docroot').
      'module/sub_account_ketujuh/template/');
      $this->SetTemplateFile('view_edit_sub_account_ketujuh.html');
   }
