...
/**
 * 
 * class ViewHistoryTransaksiKeuanganSP2D
...
require_once GTFWConfiguration::GetValue( 'application', 'docroot') . 
		'module/history_transaksi_keuangan_sp2d/business/HistoryTransaksiKeuanganSP2D.class.php';

class ViewHistoryTransaksiKeuanganSP2D extends HtmlResponse 
{
	...
	public function TemplateModule() 
	{
		...
		$this->SetTemplateFile('view_history_transaksi_keuangan_sp2d.html');
	}
	
	public function ProcessRequest() 
	{
		
		$Obj = new HistoryTransaksiKeuanganSP2D();
	...
	public function ParseTemplate($data = NULL) 
	{
		...
		for ($i=0; $i<sizeof($dataDetilTransaksi); $i++) {
			...
			if ($no % 2 != 0) 
				...
				$urlAccept = 'history_transaksi_keuangan_sp2d|DeleteJurnal|do|html';
                $urlReturn = 'history_transaksi_keuangan_sp2d|HistoryTransaksiKeuanganSP2D|view|html';
                $label = 'Jurnal Transaksi SP2D';
