...
class LaporanRekapAnggaranBelanjaBulanan extends Database
{
   ...
   {
      $this->mSqlFile   = 'module/laporan_rekap_anggaran_belanja_bulanan/business/laporan_rekap_anggaran_belanja_bulanan.sql.php';
   ...
   public function getNominalDetailBelanjaBulanan($param = array())
   {
        ...
        if(!empty($return)){
            foreach($return as $value) {
                ...
                $kegiatan    = $value['kegiatanId'];                                       
                $subKegiatan = $value['subKegiatanId'];
                ...
                $kodeSistem             = $program.'.'.$kegiatan.'.'.$subKegiatan.'.'.$value['detailBelanjaKode'];
                
                $data[$programKodeSistem][$value['bulan']] += $value['detailBelanjaNominal'];
                $data[$kegiatanKodeSistem][$value['bulan']] += $value['detailBelanjaNominal'];                      
                $data[$subKegiatanKodeSistem][$value['bulan']] += $value['detailBelanjaNominal'];
                $data[$kodeSistem][$value['bulan']] = $value['detailBelanjaNominal'];
                $data['total'][$value['bulan']] += $value['detailBelanjaNominal'];
                $data['nominal'][$programKodeSistem] += $value['detailBelanjaNominal'];
                $data['nominal'][$kegiatanKodeSistem] += $value['detailBelanjaNominal'];                      
                $data['nominal'][$subKegiatanKodeSistem] += $value['detailBelanjaNominal'];
                $data['jml_total'] += $value['detailBelanjaNominal'];
            }   
        }
