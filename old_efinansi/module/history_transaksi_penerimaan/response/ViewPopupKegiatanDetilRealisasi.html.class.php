...
'module/history_transaksi_penerimaan/business/AppPopupKegiatanDetil.class.php';
...
class ViewPopupKegiatanDetilRealisasi extends HtmlResponse {
	...
	function ParseTemplate($data = NULL) {
		...
		$this->mrTemplate->AddVar('content', 'URL_SEARCH', 
			Dispatcher::Instance()->GetUrl('history_transaksi_penerimaan', 'popupKegiatanDetilRealisasi', 'view', 'html') . '&unitkerja=' . $this->encUnitkerjaId);
		if($this->Pesan) {
