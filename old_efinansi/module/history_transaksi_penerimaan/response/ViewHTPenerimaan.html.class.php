...
require_once GTFWConfiguration::GetValue( 'application', 'docroot') . 
			'module/history_transaksi_penerimaan/business/HTPenerimaan.class.php';
	...
	public function ParseTemplate($data = NULL) 
	{
		...
		if (empty($data['dataDetilTransaksi'])) {
			...
			$this->mrTemplate->AddVar('data', 'DATA_EMPTY', 'NO');
         	...
         	$urlDelete = 'history_transaksi_penerimaan|deleteHTPenerimaan|do|html';
         	$urlReturn = 'history_transaksi_penerimaan|HTPenerimaan|view|html';
