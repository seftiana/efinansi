<?php
require_once GTFWConfiguration::GetValue( 'application', 'docroot') . 'module/transaksi_kode_jurnal_pengeluaran/business/AppPopupKegiatanUnitKerja.class.php';
...
class ViewPopupKegiatanUnitKerja extends HtmlResponse {
	...
	function ParseTemplate($data = NULL) {
		...
		$this->mrTemplate->AddVar('content', 'URL_SEARCH', Dispatcher::Instance()->GetUrl('transaksi_kode_jurnal_pengeluaran', 'popupKegiatanDetil', 'view', 'html'));
		if($this->Pesan) {
