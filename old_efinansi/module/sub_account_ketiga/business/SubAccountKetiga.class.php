 ...
 */
 ...
 /**
  * Class SubAccountKetiga
  * @todo Untuk menghandle manipulasi data dalam tabel finansi_keu_ref_subacc_3
  */
class SubAccountKetiga extends Database
{
   protected $mSqlFile;
   public $_POST;
   public $_GET;
   ...
   {
      $this->mSqlFile   = 'module/sub_account_ketiga/business/sub_account_ketiga.sql.php';
   ...
   {
      return $this->Execute($this->mSqlQueries['do_add_sub_account_ketiga'], array(
         $subAccKode,
         $subAccNama
      ));
   }
   ...
   {
      return $this->Execute($this->mSqlQueries['do_update_sub_account_ketiga'],
   ...
   {
      return $this->Execute($this->mSqlQueries['do_delete_sub_account_ketiga'], array($subAccKode));
   }
