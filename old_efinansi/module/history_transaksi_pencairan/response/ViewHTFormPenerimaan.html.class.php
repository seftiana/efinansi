...
require_once GTFWConfiguration::GetValue( 'application', 'docroot') .
		'module/history_transaksi_pencairan/business/transaksi_penerimaan/AppTransaksi.class.php';

require_once GTFWConfiguration::GetValue( 'application', 'docroot') .
		'module/user_unit_kerja/business/UserUnitKerja.class.php';

class ViewHTFormPenerimaan extends HtmlResponse
{
	...
	public function TemplateModule()
	{
		...
		$this->SetTemplateFile('transaksi_penerimaan/view_transaksi.html');
	}
	...
	public function ProcessRequest()
	{
      ...
      /**
		Messenger::Instance()->SendToComponent('combobox', 'Combobox', 'view', 'html', 'tipe_transaksi',
								array('tipe_transaksi', $arr_tipe_transaksi, $this->Data['tipe_transaksi'],
								"false", ' style="width:200px; display:none;"
								onChange="jsCheck(this.value)" id="tipe_transaksi"'),
								Messenger::CurrentRequest);
      */
	...
	public function ParseTemplate($data = NULL)
	{
		...
		$this->mrTemplate->AddVar('content','NAME_TIPE_TRANSAKSI',$data['tipe_transaksi'][0]['name']);
      	$url_view = Dispatcher::Instance()->GetUrl('history_transaksi_pencairan', 'HTFormPenerimaan', 'view', 'html');
