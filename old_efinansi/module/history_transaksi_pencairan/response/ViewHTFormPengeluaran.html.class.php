...
require_once GTFWConfiguration::GetValue( 'application', 'docroot') .
	'module/history_transaksi_pencairan/business/transaksi_pengeluaran/AppTransaksi.class.php';

require_once GTFWConfiguration::GetValue( 'application', 'docroot') .
		'module/user_unit_kerja/business/UserUnitKerja.class.php';

class ViewHTFormPengeluaran extends HtmlResponse
{
	...
	public function TemplateModule()
	{
		...
		$this->SetTemplateFile('transaksi_pengeluaran/view_transaksi.html');
	}
	...
	public function ProcessRequest()
	{
		...
		if($_POST || isset($_GET['cari'])) {
      	...
      	if(isset($_GET['dataId'])) {
			...
			$return['datadb'] = $datadb;
         	...
         	$tanggal_transaksi_selected = $tanggal_transaksi_year . "-" .
	 								      $tanggal_transaksi_mon . "-" .
										  $tanggal_transaksi_day;
      	}
		...
		$return['thnb'] = $thnB[0]['tppId'];
      	...
      	//due_date
      	Messenger::Instance()->SendToComponent('tanggal', 'Tanggal', 'view', 'html', 'due_date',
		  									array($due_date_selected, $periode_awal, $periode_akhir),
					  						Messenger::CurrentRequest);

      	//tanggal_transaksi
      	Messenger::Instance()->SendToComponent('tanggal', 'Tanggal', 'view', 'html', 'tanggal_transaksi',
		  									array($tanggal_transaksi_selected, $periode_awal, $periode_akhir),
					  						Messenger::CurrentRequest);
		...
		Messenger::Instance()->SendToComponent('combobox', 'Combobox', 'view', 'html', 'jenis_transaksi',
												array(
													'jenis_transaksi',
													$arr_jenis_transaksi, 1,
													"false",
													' style="width:200px;" id="jenis_transaksi"'),
												Messenger::CurrentRequest);

		/**
		 * Messenger::Instance()->SendToComponent('combobox', 'Combobox', 'view', 'html', 'jenis_transaksi',
			array('jenis_transaksi',$arr_jenis_transaksi, 1,"false",
		...
		*/
		...
		Messenger::Instance()->SendToComponent('combobox', 'Combobox', 'view', 'html', 'tipe_transaksi',
											array(
													'tipe_transaksi',
													$arr_tipe_transaksi, $this->Data['tipe_transaksi'],
													"false",
													' style="width:200px; display:none;"  id="tipe_transaksi"'),
											Messenger::CurrentRequest);
	...
	public function ParseTemplate($data = NULL)
	{
		...
		$this->mrTemplate->AddVar('content','NAME_TIPE_TRANSAKSI',$data['tipe_transaksi'][0]['name']);
      	$url_view = Dispatcher::Instance()->GetUrl('history_transaksi_pencairan', 'HTFormPengeluaran', 'view', 'html');
      	...
      	if(empty($datadbFile)) {
			...
			$no_file_list = $data['no_file_list'];
         	...
         	for($i=0;$i<sizeof($datadbFile);$i++) {
            	...
            	//$datadbFile[$i]['url_delete'] = $url_view . "&no_file_delete=" .
				//Dispatcher::Instance()->Encrypt($nilai);
