...
class LoggerDetail extends Database {

   protected $mSqlFile= 'module/logger_detail/business/loggerdetail.sql.php';
   ...
   function InsertLoggerDetail($params){
      return $this->Execute($this->mSqlQueries['insert_logger_detail'], $params);
   }
 }
?>