...
class ViewTransaksi extends HtmlResponse {
	...
	function TemplateModule() {
		$this->SetTemplateBasedir(GTFWConfiguration::GetValue('application','docroot').
			'module/transaksi_realisasi_penerimaan/template');
	...
	function ParseTemplate($data = NULL) {
      $url_view = Dispatcher::Instance()->GetUrl('transaksi_realisasi_penerimaan', 'transaksi', 'view', 'html');
		$userRealName = trim(Security::Instance()->mAuthentication->GetCurrentUser()->GetRealName());
		...
		$this->mrTemplate->AddVar('content', 'URL_DETIL', 
					Dispatcher::Instance()->GetUrl(
								'transaksi_realisasi_penerimaan', 
								'detilTransaksi', 
								'view', 
								'html'));
      ...
      if(isset($_GET['dataId']) AND $_GET['dataId']->Integer()->Raw() > 0) {
         ...
         $this->mrTemplate->AddVar('content', "MODE_20080109", 'Tambah');
		   $this->mrTemplate->AddVar('content', 'URL_ACTION', 
		   	Dispatcher::Instance()->GetUrl('transaksi_realisasi_penerimaan', 'addTransaksi', 'do', 'html'));
      }
