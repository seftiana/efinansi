...
require_once GTFWConfiguration::GetValue('application', 'docroot') . 'module/transaksi_realisasi_penerimaan/business/AppDetilTransaksi.class.php';
...
class ViewDetilTransaksi extends HtmlResponse {
    ...
    function TemplateModule() {
        $this->SetTemplateBasedir(GTFWConfiguration::GetValue('application', 'docroot') . 'module/transaksi_realisasi_penerimaan/template');
    ...
    function ParseTemplate($data = NULL) {
        $this->mrTemplate->AddVar('content', 'URL_SEARCH', Dispatcher::Instance()->GetUrl('transaksi_realisasi_penerimaan', 'detilTransaksi', 'view', 'html'));
        $this->mrTemplate->AddVar('content', 'URL_KEMBALI', Dispatcher::Instance()->GetUrl('transaksi_realisasi_penerimaan', 'Transaksi', 'view', 'html'));
        if ($this->Pesan) {
        ...
        if (empty($data['dataDetilTransaksi'])) {
            ...
            $label = 'Transaksi';
            $urlDelete = 'transaksi_realisasi_penerimaan|deleteTransaksi|do|html';
            $urlReturn = 'transaksi_realisasi_penerimaan|detilTransaksi|view|html';
            $URLDELETE = Dispatcher::Instance()->GetUrl('transaksi_realisasi_penerimaan', 'deleteTransaksi', 'do', 'html');

//mulai bikin tombol delete
            #$label = "Transaksi";
            #$urlDelete = Dispatcher::Instance()->GetUrl('transaksi_realisasi_penerimaan', 'deleteTransaksi', 'do', 'html');
            #$urlReturn = Dispatcher::Instance()->GetUrl('transaksi_realisasi_penerimaan', 'detilTransaksi', 'view', 'html');
            ...
            for ($i = 0; $i < sizeof($dataDetilTransaksi); $i++) {
                ...
                if ($dataDetilTransaksi[$i]['tipe_id'] == 1) {
                    $dataDetilTransaksi[$i]['url_cetak_bukti'] = Dispatcher::Instance()->GetUrl('transaksi_realisasi_penerimaan', 'FormCetakBKM', 'view', 'html') . '&dataId=' . $idEnc . '&tipe=bkm';
                    $dataDetilTransaksi[$i]['label_cetak_bukti'] = 'Cetak BKM';
                    #$url_cetak_bukti = Dispatcher::Instance()->GetUrl('transaksi_realisasi_penerimaan', 'CetakBuktiTransaksi', 'view', 'html') . '&dataId=' . $idEnc . '&tipe=bkm';
                    ...
                    $dataDetilTransaksi[$i]['url_cetak_bukti'] = Dispatcher::Instance()->GetUrl('transaksi_realisasi_penerimaan', 'FormCetakBKK', 'view', 'html') . '&dataId=' . $idEnc . '&tipe=bkk';
                    $dataDetilTransaksi[$i]['label_cetak_bukti'] = 'Cetak BKK';
                    #$url_cetak_bukti = Dispatcher::Instance()->GetUrl('transaksi_realisasi_penerimaan', 'CetakBuktiTransaksi', 'view', 'html') . '&dataId=' . $idEnc . '&tipe=bkk';
                    ...
                    $dataDetilTransaksi[$i]['url_cetak_bukti'] = Dispatcher::Instance()->GetUrl('transaksi_realisasi_penerimaan', 'FormCetakBM', 'view', 'html') . '&dataId=' . $idEnc . '&tipe=bm';
                ...
                $dataDetilTransaksi[$i]['url_cetak'] = Dispatcher::Instance()->GetUrl('transaksi_realisasi_penerimaan', 'FormCetakTransaksi', 'view', 'html') . '&dataId=' . $idEnc;
                $dataDetilTransaksi[$i]['url_cetak_rtf'] = Dispatcher::Instance()->GetUrl('transaksi_realisasi_penerimaan', 'rtfSSBP', 'print', 'rtf') . '&dataId=' . $idEnc;
                ...
                if ($dataDetilTransaksi[$i]['is_jurnal'] == "Y") {
                    ...
                    $url_edit = Dispatcher::Instance()->GetUrl('transaksi_realisasi_penerimaan', 'Transaksi', 'view', 'html') . '&dataId=' . $idEnc;
