...
class ProcessRencanaPengeluaran
{
   ...
   protected $komp;
   protected $moduleName   = 'rencana_pengeluaran';
   ...
   public function Validate()
   {
      $mData      = $this->data;
      if(empty($mData)){
         $err[]   = 'Tidak ada data '.GTFWConfiguration::GetValue('language', 'manajemen_rencana_pengeluaran');
      }
   ...
   function AddRutin()
   {
      ...
      if($validate['result'] === false){
         ...
         if($process === true){
            $message    = 'Proses penambahan '.GTFWConfiguration::GetValue('language', 'manajemen_rencana_pengeluaran').' Berhasil';
            $style      = 'notebox-done';
            Messenger::Instance()->Send(
               'rencana_pengeluaran',
               'RencanaPengeluaran',
            ...
            $message    = 'Proses penambahan '.GTFWConfiguration::GetValue('language', 'manajemen_rencana_pengeluaran').' Gagal';
            $style      = 'notebox-warning';
            Messenger::Instance()->Send(
               'rencana_pengeluaran',
               'inputRencanaPengeluaranRutin',
   ...
   function UpdateRutin()
   {
      ...
      if($validate['result'] === false){
         ...
         if($process === true){
            $message    = 'Proses update '.GTFWConfiguration::GetValue('language', 'manajemen_rencana_pengeluaran').' Berhasil';
            $style      = 'notebox-done';
            Messenger::Instance()->Send(
               'rencana_pengeluaran',
               'RencanaPengeluaran',
            ...
            $message    = 'Proses update '.GTFWConfiguration::GetValue('language', 'manajemen_rencana_pengeluaran').' Gagal';
            $style      = 'notebox-warning';
            Messenger::Instance()->Send(
               'rencana_pengeluaran',
               'inputRencanaPengeluaranRutin',
