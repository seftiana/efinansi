...
require_once GTFWConfiguration::GetValue( 'application', 'docroot') . 
			'module/history_transaksi_kode_jurnal/business/HTKodeJurnal.class.php';

class ViewHTKodeJurnal extends HtmlResponse 
{
	...
	public function TemplateModule() 
	{
		...
		$this->SetTemplateFile('view_ht_kode_jurnal.html');
	}
	
	public function ProcessRequest() 
	{
	  $Obj = new HTKodeJurnal();
	...
	public function ParseTemplate($data = NULL) 
	{
		...
		if (empty($data['dataDetilTransaksi'])) {
			...
			$this->mrTemplate->AddVar('data', 'DATA_EMPTY', 'NO');
         	...
         	$label = GTFWConfiguration::GetValue('language','transaksi_kode_jurnal');
         	$urlDelete = 'history_transaksi_kode_jurnal|deleteTransaksi|do|html';
         	$urlReturn = 'history_transaksi_kode_jurnal|HTKodeJurnal|view|html';
