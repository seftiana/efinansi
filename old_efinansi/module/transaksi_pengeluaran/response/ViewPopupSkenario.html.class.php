<?php
require_once GTFWConfiguration::GetValue( 'application', 'docroot') . 'module/transaksi_pengeluaran/business/AppPopupSkenario.class.php';
...
//combo jenis
	...
	function ParseTemplate($data = NULL) {
      ...
      if($data['search']['jenis'] == "auto") {
		...
		$this->mrTemplate->AddVar('content', 'URL_SEARCH', Dispatcher::Instance()->GetUrl('transaksi', 'popupSkenario', 'view', 'html'));
		if($this->Pesan) {
