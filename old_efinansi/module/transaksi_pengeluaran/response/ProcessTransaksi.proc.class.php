...
class ProcessTransaksi {
	...
	function Add() { 
        ...
        // }else{   
         ...
         //echo "666";
         Messenger::Instance()->Send('transaksi_pengeluaran', 'Transaksi', 'view', 'html', array($this->_POST,'Transaksi Dengan Nomor <b>'.($this->_POST['no_kkb']).'</b> Sudah Dibuat', $this->cssFail),Messenger::NextRequest);
      } else {
         //gagal masukin data
         Messenger::Instance()->Send('transaksi_pengeluaran', 'Transaksi', 'view', 'html', array($this->_POST,'Gagal Menambah Data', $this->cssFail),Messenger::NextRequest);
      }
         //exit();
	...
	function Update() {
      ...
      $cek = true;
        ...
        // }
         ...
         //gagal masukin data
         //echo "gagal";
         Messenger::Instance()->Send('transaksi_pengeluaran', 'Transaksi', 'view', 'html', array($this->_POST,'Gagal Merubah Data Transaksi', $this->cssFail),Messenger::NextRequest);
		   return $this->pageView . '&dataId=' . $this->encId;
      }
      //echo "adflj";
		return $this->pageView;
