...
class ViewPosting extends HtmlResponse {
    ...
    function ProcessRequest() {
        ...
        $dataJurnalDueDate = $Obj->getJurnalDueDate($requestData['last_posting']);
        $countJurnalDueDate = $Obj->countJurnalDueDate($requestData['last_posting']);
    ...
    function ParseTemplate($data = NULL) {
        ...
        if (empty($jurnalDueDate) && $statePosting == 1) {
