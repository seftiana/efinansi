<?php
require_once GTFWConfiguration::GetValue( 'application', 'docroot') . 'module/history_transaksi_kode_jurnal_penerimaan/business/AppTransaksi.class.php';
...
class ViewFormCetakTransaksi extends HtmlResponse {
	...
	function TemplateModule() {
		$this->SetTemplateBasedir(GTFWConfiguration::GetValue('application','docroot') . 'module/history_transaksi_kode_jurnal_penerimaan/template');
	...
	function ProcessRequest() {
		...
		/*$arr_pejabat_pembantu_rektor = array();
		$arr_pejabat_pembantu_rektor[0]['id'] = 'Pembantu Rektor I';
		$arr_pejabat_pembantu_rektor[0]['name'] = 'Pembantu Rektor I';
		$arr_pejabat_pembantu_rektor[1]['id'] = 'Pembantu Rektor II';
		$arr_pejabat_pembantu_rektor[1]['name'] = 'Pembantu Rektor II';*/
      $arr_pejabat_pembantu_rektor = $Obj->GetJabatanNama('rektor');
		...
		/*$arr_pejabat_bendahara = array();
		$arr_pejabat_bendahara[0]['id'] = 'Bendahara Pengeluaran';
		$arr_pejabat_bendahara[0]['name'] = 'Bendahara Pengeluaran';
		$arr_pejabat_bendahara[1]['id'] = 'PUMN APBN';
		$arr_pejabat_bendahara[1]['name'] = 'PUMN APBN';
		$arr_pejabat_bendahara[2]['id'] = 'PUMN APBD Tk. I';
		$arr_pejabat_bendahara[2]['name'] = 'PUMN APBD Tk. I';
		$arr_pejabat_bendahara[3]['id'] = 'PUMN APBD Tk. II';
		$arr_pejabat_bendahara[3]['name'] = 'PUMN APBD Tk. II';*/
	...
	function ParseTemplate($data = NULL) {
		...
		$this->mrTemplate->AddVar('content', 'URL_ACTION', Dispatcher::Instance()->GetUrl('history_transaksi_kode_jurnal_penerimaan', 'cetakTransaksi', 'view', 'html') . "&dataId=" . Dispatcher::Instance()->Encrypt($data['decDataId']));
		$this->mrTemplate->AddVar('content', 'URL_CETAK', Dispatcher::Instance()->GetUrl('history_transaksi_kode_jurnal_penerimaan', 'cetakTransaksi', 'view', 'html') . "&dataId=" . Dispatcher::Instance()->Encrypt($data['decDataId']));
		$this->mrTemplate->AddVar('content', 'URL_BATAL', Dispatcher::Instance()->GetUrl('history_transaksi_kode_jurnal_penerimaan', 'HTKodeJurnalPenerimaan', 'view', 'html'));
