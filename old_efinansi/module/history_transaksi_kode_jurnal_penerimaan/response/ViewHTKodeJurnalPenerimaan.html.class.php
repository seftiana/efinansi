...
require_once GTFWConfiguration::GetValue( 'application', 'docroot') . 
		'module/history_transaksi_kode_jurnal_penerimaan/business/HTKodeJurnalPenerimaan.class.php';

class ViewHTKodeJurnalPenerimaan extends HtmlResponse 
{
	...
	public function TemplateModule() 
	{
		$this->SetTemplateBasedir(GTFWConfiguration::GetValue('application','docroot').
				'module/history_transaksi_kode_jurnal_penerimaan/template');
		$this->SetTemplateFile('view_ht_kode_jurnal_penerimaan.html');
	}
	
	public function ProcessRequest() 
	{
		$Obj = new HTKodeJurnalPenerimaan();
	...
	public function ParseTemplate($data = NULL) 
	{
		$this->mrTemplate->AddVar('content', 'URL_SEARCH', 
									Dispatcher::Instance()->GetUrl(
													'history_transaksi_kode_jurnal_penerimaan', 
		...
		if (empty($data['dataDetilTransaksi'])) {
			...
			$this->mrTemplate->AddVar('data', 'DATA_EMPTY', 'NO');
         	...
         	$label =GTFWConfiguration::GetValue('language','transaksi_kode_jurnal_penerimaan');
         	$urlDelete = 'history_transaksi_kode_jurnal_penerimaan|deleteTransaksi|do|html';
         	$urlReturn = 'history_transaksi_kode_jurnal_penerimaan|HTKodeJurnalPenerimaan|view|html';
         	//$urlReturn = 'history_transaksi|HTKodeJurnalPenerimaan|view|html';
