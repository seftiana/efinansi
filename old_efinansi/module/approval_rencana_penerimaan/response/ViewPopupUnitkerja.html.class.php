...
require_once GTFWConfiguration::GetValue('application', 'docroot') .
        'module/approval_rencana_penerimaan/business/AppPopupUnitkerja.class.php';
require_once GTFWConfiguration::GetValue('application', 'docroot') .
...
class ViewPopupUnitkerja extends HtmlResponse {
    ...
    function ProcessRequest() {
        ...
        $totalData = $this->unitkerjaObj->GetCountDataUnitkerja(
                $kode, $unitkerja, $tipeunit, $unitkerjaUserId['unit_kerja_id']);
        $itemViewed = 20;
        $currPage = 1;
        $startRec = 0;
        if (isset($_GET['page'])) {
        ...
        $dataUnitkerja = $this->unitkerjaObj->getDataUnitkerja(
                $startRec, $itemViewed, $kode, $unitkerja, $tipeunit, $unitkerjaUserId['unit_kerja_id']);
        ...
        Messenger::Instance()->SendToComponent(
                'combobox', 'Combobox', 'view', 'html', 'tipeunit', array(
            'tipeunit',
            $arr_tipeunit,
            $tipeunit,
            'true',
