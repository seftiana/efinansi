...
SELECT
  ...
  IFNULL(`lapLppaDetailNominal`,0) AS nominal_lppa,
  (peng_real_det.`pengrealdetNominalApprove` - (IFNULL(`lapLppaDetailNominal`,0))) AS nominal
FROM `pengajuan_realisasi_detil` peng_real_det
  INNER JOIN rencana_pengeluaran rpeng 
