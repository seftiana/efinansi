<?php
require_once GTFWConfiguration::GetValue( 'application', 'docroot') . 'module/transaksi_kode_jurnal_penerimaan/business/AppPopupMakPenerimaan.class.php';
...
class ViewPopupMakPenerimaan extends HtmlResponse {
	...
	function ParseTemplate($data = NULL) {
		...
		$this->mrTemplate->AddVar('content', 'URL_SEARCH', Dispatcher::Instance()->GetUrl('transaksi_kode_jurnal_penerimaan', 'PopupMakPenerimaan', 'view', 'html'));
		if($this->Pesan) {
