...
class ViewFormCetakBKM extends HtmlResponse {
	...
	function ProcessRequest() {
		...
		$arr_pejabat_biro_keuangan = $Obj->GetJabatanNama('BENDAHARA');
		Messenger::Instance()->SendToComponent('combobox', 'Combobox', 'view', 'html', 'pejabat_keuangan', array('pejabat_keuangan', $arr_pejabat_biro_keuangan, '', '-', ' id="pejabat_keuangan" style="width:200px;" '), Messenger::CurrentRequest);
	...
	function ParseTemplate($data = NULL) {
		...
		$this->mrTemplate->AddVar('content', 'URL_ACTION', Dispatcher::Instance()->GetUrl('history_transaksi_spj_pertransaksi', 'CetakBuktiTransaksi', 'view', 'html') . "&dataId=" . Dispatcher::Instance()->Encrypt($data['decDataId']) . '&tipe=bkm');
		$this->mrTemplate->AddVar('content', 'URL_CETAK', Dispatcher::Instance()->GetUrl('history_transaksi_spj_pertransaksi', 'CetakBuktiTransaksi', 'view', 'html') . "&dataId=" . Dispatcher::Instance()->Encrypt($data['decDataId']) . '&tipe=bkm');
