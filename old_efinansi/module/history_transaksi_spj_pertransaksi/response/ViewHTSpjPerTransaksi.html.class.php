...
require_once GTFWConfiguration::GetValue( 'application', 'docroot') . 
				'module/history_transaksi_spj_pertransaksi/business/HTSpjPerTransaksi.class.php';
...
class ViewHTSpjPerTransaksi extends HtmlResponse 
{
	...
	public function TemplateModule() 
	{
		$this->SetTemplateBasedir(GTFWConfiguration::GetValue('application','docroot').
						'module/history_transaksi_spj_pertransaksi/template');
	...
	public function ParseTemplate($data = NULL) 
	{
		$this->mrTemplate->AddVar('content', 'URL_SEARCH', 
											Dispatcher::Instance()->GetUrl(
															'history_transaksi_spj_pertransaksi', 
															'HTSpjPerTransaksi', 
															'view', 
															'html'));
		...
		if (empty($data['dataDetilTransaksi'])) {
			...
			$this->mrTemplate->AddVar('data', 'DATA_EMPTY', 'NO');
         	...
         	$label = 'Transaksi';
         	$urlDelete = 'history_transaksi_spj_pertransaksi|deleteTransaksi|do|html';
         	$urlReturn = 'history_transaksi_spj_pertransaksi|detilTransaksi|view|html';
